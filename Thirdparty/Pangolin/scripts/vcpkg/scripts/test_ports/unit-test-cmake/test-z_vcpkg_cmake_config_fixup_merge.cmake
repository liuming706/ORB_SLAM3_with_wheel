...
unit_test_check_variable_equal(
  [[z_vcpkg_cmake_config_fixup_merge(merged release_libs debug_libs)]] merged
  "namespace::C++_shared")
...
unit_test_check_variable_equal(
  [[z_vcpkg_cmake_config_fixup_merge(merged release_libs debug_libs)]] merged
  [[\$<\$<NOT:\$<CONFIG:DEBUG>>:A>;\$<\$<CONFIG:DEBUG>:B>]])

set(release_libs A B)
set(debug_libs A)
unit_test_check_variable_equal(
  [[z_vcpkg_cmake_config_fixup_merge(merged release_libs debug_libs)]] merged
  [[A;\$<\$<NOT:\$<CONFIG:DEBUG>>:B>]])
...
unit_test_check_variable_equal(
  ...
  merged
  [[\$<\$<NOT:\$<CONFIG:DEBUG>>:A>;\$<\$<CONFIG:DEBUG>:C>;\$<\$<NOT:\$<CONFIG:DEBUG>>:C>]]
)
