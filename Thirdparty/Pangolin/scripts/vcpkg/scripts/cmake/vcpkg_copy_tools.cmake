function(vcpkg_copy_tools)
  cmake_parse_arguments(PARSE_ARGV 0 arg "AUTO_CLEAN" "SEARCH_DIR;DESTINATION"
                        "TOOL_NAMES")
  ...
  foreach(tool_name IN LISTS arg_TOOL_NAMES)
    set(tool_path
        "${arg_SEARCH_DIR}/${tool_name}${VCPKG_TARGET_EXECUTABLE_SUFFIX}")
    ...
    elseif(NOT "${VCPKG_TARGET_BUNDLE_SUFFIX}" STREQUAL ""
      ...
      set(bundle_path
          "${arg_SEARCH_DIR}/${tool_name}${VCPKG_TARGET_BUNDLE_SUFFIX}")
