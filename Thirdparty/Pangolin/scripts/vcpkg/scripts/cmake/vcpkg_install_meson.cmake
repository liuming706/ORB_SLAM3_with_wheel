function(vcpkg_install_meson)
  ...
  unset(ENV{DESTDIR}) # installation directory was already specified with
                      # '--prefix' option
  ...
  if(VCPKG_TARGET_IS_OSX)
    ...
    set(ENV{MACOSX_DEPLOYMENT_TARGET}
        "${VCPKG_DETECTED_CMAKE_OSX_DEPLOYMENT_TARGET}")
  endif()
  ...
  foreach(buildtype IN ITEMS "debug" "release")
    ...
    vcpkg_execute_required_process(
      ...
      LOGNAME
      package-${TARGET_TRIPLET}-${short_buildtype})
    if(arg_ADD_BIN_TO_PATH)
  ...
  if(VCPKG_TARGET_IS_WINDOWS
    ...
    # Meson names all static libraries lib<name>.a which basically breaks the
    # world
    ...
    foreach(cmake_file IN LISTS cmake_files)
      foreach(current_lib IN LISTS renamed_libs)
        vcpkg_replace_string("${cmake_file}" "${${current_lib}_old}"
                             "${${current_lib}_new}")
      endforeach()
    endforeach()
  endif()
