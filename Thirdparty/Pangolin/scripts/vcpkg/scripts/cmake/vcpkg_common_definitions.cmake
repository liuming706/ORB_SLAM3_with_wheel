string(COMPARE NOTEQUAL "${TARGET_TRIPLET}" "${HOST_TRIPLET}"
...
# set(CMAKE_EXECUTABLE_SUFFIX ${VCPKG_HOST_EXECUTABLE_SUFFIX}) not required by
# find_program
...
elseif(VCPKG_TARGET_IS_WINDOWS)
  ...
  set(VCPKG_FIND_LIBRARY_SUFFIXES ".lib" ".dll") # This is a slight modification
                                                 # to CMakes value which does
                                                 # not include ".dll".
  set(VCPKG_FIND_LIBRARY_PREFIXES "" "lib") # This is a slight modification to
                                            # CMakes value which does not
                                            # include "lib".
...
# Setting these variables allows find_library to work in script mode and thus in
# portfiles! This allows us scale down on hardcoded target dependent paths in
# portfiles
...
set(CMAKE_FIND_LIBRARY_SUFFIXES
    ...
    CACHE INTERNAL "") # Required by find_library
set(CMAKE_FIND_LIBRARY_PREFIXES
    "${VCPKG_FIND_LIBRARY_PREFIXES}"
    CACHE INTERNAL "") # Required by find_library

# Append platform libraries to VCPKG_SYSTEM_LIBRARIES The variable are just
