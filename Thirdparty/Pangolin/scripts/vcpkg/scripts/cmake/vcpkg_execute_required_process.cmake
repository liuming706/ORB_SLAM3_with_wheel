function(vcpkg_execute_required_process)
  cmake_parse_arguments(
    PARSE_ARGV 0 arg "ALLOW_IN_DOWNLOAD_MODE"
...
Halting portfile execution.
  ...
  if(DEFINED arg_OUTPUT_VARIABLE
     AND DEFINED arg_ERROR_VARIABLE
     AND arg_OUTPUT_VARIABLE STREQUAL arg_ERROR_VARIABLE)
  ...
  foreach(logfile IN LISTS arg_SAVE_LOG_FILES)
    ...
    configure_file(
      "${filepath}" "${CURRENT_BUILDTREES_DIR}/${arg_LOGNAME}-${filename}"
      COPYONLY)
    vcpkg_list(APPEND saved_logs
               "${CURRENT_BUILDTREES_DIR}/${arg_LOGNAME}-${filename}")
  endforeach()
