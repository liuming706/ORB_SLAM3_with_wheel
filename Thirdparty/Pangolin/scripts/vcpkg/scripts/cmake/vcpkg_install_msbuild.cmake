function(vcpkg_install_msbuild)
  ...
  if(DEFINED arg_UNPARSED_ARGUMENTS)
    message(
      WARNING
        "vcpkg_install_msbuild was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}"
    )
  endif()
  ...
  if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    # Disable LTCG for static libraries because this setting introduces ABI
    # incompatibility between minor compiler versions TODO: Add a way for the
    # user to override this if they want to opt-in to incompatibility
  ...
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    ...
    vcpkg_execute_required_process(
      COMMAND
      msbuild
      "${source_copy_path}/${arg_PROJECT_SUBPATH}"
  ...
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    ...
    set(source_copy_path
        "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/${source_path_suffix}")
    vcpkg_execute_required_process(
      COMMAND
      msbuild
      "${source_copy_path}/${arg_PROJECT_SUBPATH}"
  ...
  if(DEFINED arg_LICENSE_SUBPATH)
    file(
      INSTALL "${arg_SOURCE_PATH}/${arg_LICENSE_SUBPATH}"
