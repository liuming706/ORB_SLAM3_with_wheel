...
function(z_vcpkg_get_visual_studio_generator)
  ...
  if(DEFINED ENV{VisualStudioVersion})
    if("$ENV{VisualStudioVersion}" VERSION_LESS_EQUAL "12.99"
       AND "$ENV{VisualStudioVersion}" VERSION_GREATER_EQUAL "12.0"
       AND NOT "${VCPKG_TARGET_ARCHITECTURE}" STREQUAL "arm64")
      set(generator "Visual Studio 12 2013")
    elseif("$ENV{VisualStudioVersion}" VERSION_LESS_EQUAL "14.99"
           AND NOT "${VCPKG_TARGET_ARCHITECTURE}" STREQUAL "arm64")
...
function(z_vcpkg_select_default_vcpkg_chainload_toolchain)
  # Try avoiding adding more defaults here. Set VCPKG_CHAINLOAD_TOOLCHAIN_FILE
  # explicitly in the triplet.
...
function(vcpkg_configure_cmake)
  ...
  if(NOT arg_Z_GET_CMAKE_VARS_USAGE AND Z_VCPKG_CMAKE_CONFIGURE_GUARD)
    message(
      FATAL_ERROR
        "The ${PORT} port already depends on vcpkg-cmake; using both vcpkg-cmake and vcpkg_configure_cmake in the same port is unsupported."
    )
  endif()
  ...
  elseif(NOT ninja_can_be_used)
    set(generator "")
    z_vcpkg_get_visual_studio_generator(OUT_GENERATOR generator OUT_ARCH
                                        generator_arch)
  ...
  if("${generator}" STREQUAL "Ninja" AND NOT DEFINED
  ...
  z_vcpkg_configure_cmake_both_or_neither_set(VCPKG_CXX_FLAGS_DEBUG
                                              VCPKG_C_FLAGS_DEBUG)
  z_vcpkg_configure_cmake_both_or_neither_set(VCPKG_CXX_FLAGS_RELEASE
  ...
  if(ninja_host
     ...
     AND NOT arg_DISABLE_PARALLEL_CONFIGURE)
    ...
    vcpkg_list(
      APPEND config_logs "${CURRENT_BUILDTREES_DIR}/${arg_LOGNAME}-out.log"
