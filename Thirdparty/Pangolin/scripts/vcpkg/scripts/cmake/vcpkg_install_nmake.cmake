function(vcpkg_install_nmake)
  ...
  cmake_parse_arguments(
    PARSE_ARGV 0 arg "NO_DEBUG;PREFER_JOM"
  ...
  # backwards-compatibility hack gdal passes `arg_OPTIONS_DEBUG` (and RELEASE)
  # as a single argument, so we need to split them again
  ...
  vcpkg_build_nmake(SOURCE_PATH "${arg_SOURCE_PATH}" ENABLE_INSTALL
                    LOGFILE_ROOT install ${extra_args})
endfunction()
