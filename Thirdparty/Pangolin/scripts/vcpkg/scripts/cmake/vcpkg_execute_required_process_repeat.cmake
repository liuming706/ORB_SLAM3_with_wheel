function(vcpkg_execute_required_process_repeat)
  cmake_parse_arguments(PARSE_ARGV 0 arg "ALLOW_IN_DOWNLOAD_MODE"
                        "COUNT;WORKING_DIRECTORY;LOGNAME" "COMMAND")
  ...
  if(NOT arg_COUNT GREATER_EQUAL "1")
    message(
      FATAL_ERROR "COUNT (${arg_COUNT}) must be greater than or equal to 1.")
  endif()
...
Halting portfile execution.
  ...
  foreach(loop_count RANGE 1 ${arg_COUNT})
    set(out_log
        "${CURRENT_BUILDTREES_DIR}/${arg_LOGNAME}-out-${loop_count}.log")
    set(err_log
        "${CURRENT_BUILDTREES_DIR}/${arg_LOGNAME}-out-${loop_count}.log")
