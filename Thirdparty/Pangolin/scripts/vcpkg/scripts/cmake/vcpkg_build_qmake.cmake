...
function(vcpkg_build_qmake)
  ...
  # This fixes issues on machines with default codepages that are not ASCII
  # compatible, such as some CJK encodings
  set(ENV{_CL_} "/utf-8")
  ...
  foreach(build_type IN ITEMS ${items})
    ...
    if(CMAKE_HOST_UNIX)
      ...
      vcpkg_host_path_list(
        APPEND ENV{LD_LIBRARY_PATH} "${current_installed_prefix}/lib"
        "${current_installed_prefix}/lib/manual-link")
    endif()
