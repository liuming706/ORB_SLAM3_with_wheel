if(NOT "sdl2" IN_LIST FEATURES AND NOT "sfml" IN_LIST FEATURES)
  message(
    FATAL_ERROR
      "At least one of the backend features must be selected: sdl2 sfml")
endif()
...
vcpkg_from_github(
  ...
  v0.9.5
  SHA512
  68c02679598448440ffaad69ee606a8413c2bcb508c91a59c2997ac866681617dadf6b9688f6c5eb07e5e38b5094a39bd79f0753a82236ec5f48498797c11134
  HEAD_REF
  0.10
  PATCHES
...
file(REMOVE_RECURSE "${SOURCE_PATH}/src/Backends/SDL/cmake_modules") # Config
                                                                     # available
...
if("tool" IN_LIST FEATURES)
  message(
    STATUS
      "Check for: ${TGUI_SHARE_PATH}/gui-builder/gui-builder${VCPKG_TARGET_EXECUTABLE_SUFFIX}"
  )
  if(EXISTS
    ...
    file(COPY "${TGUI_SHARE_PATH}/gui-builder/resources"
         DESTINATION "${TGUI_TOOLS_PATH}")
    file(COPY "${TGUI_SHARE_PATH}/gui-builder/themes"
         DESTINATION "${TGUI_TOOLS_PATH}")
