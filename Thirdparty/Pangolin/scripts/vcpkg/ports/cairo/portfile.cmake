...
vcpkg_from_gitlab(
  ...
  cairo/cairo
  REF
  b43e7c6f3cf7855e16170a06d3a9c7234c60ca94 # v1.17.6
  SHA512
  2d8f0cbb11638610eda104a370bb8450e28d835852b0f861928738a60949e0aaba7a554a9f9efabbefda10a37616d4cd0d3021b3fbb4ced1d52db1edb49bc358
  HEAD_REF
  master
  PATCHES
  cairo_static_fix.patch
  disable-atomic-ops-check.patch # See
                                 # https://gitlab.freedesktop.org/cairo/cairo/-/issues/554
...
# TODO: Fix script set(TOOLS) if(EXISTS
# "${CURRENT_PACKAGES_DIR}/bin/cairo-trace${VCPKG_TARGET_EXECUTABLE_SUFFIX}")
# list(APPEND TOOLS cairo-trace) # sh script which needs to be fixed due to
# absolute paths in it. endif() vcpkg_copy_tools(TOOL_NAMES ${TOOLS} AUTO_CLEAN)
