vcpkg_from_github(
  ...
  v1.9.2
  SHA512
  f067b227bc784e1dee61261d540632e54a4e5849934d1f55571979fea6b3c6858c27bcd397cf33fbee2409df12b149bb78f201f33646d14b5288a33147a9c9dc
  HEAD_REF
  master
  PATCHES
  lz4.patch
...
vcpkg_cmake_config_fixup(PACKAGE_NAME RdKafka CONFIG_PATH lib/cmake/RdKafka)
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL static)
  foreach(hdr rdkafka.h rdkafkacpp.h)
    vcpkg_replace_string(
      ...
      "#ifdef LIBRDKAFKA_STATICLIB" "#if 1 // #ifdef LIBRDKAFKA_STATICLIB")
  endforeach()
endif()

# Handle copyright
configure_file("${SOURCE_PATH}/LICENSES.txt"
