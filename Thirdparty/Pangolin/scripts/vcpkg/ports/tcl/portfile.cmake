vcpkg_from_github(
  ...
  tcltk/tcl
  REF
  0fa6a4e5aad821a5c34fdfa070c37c3f1ffc8c8e
  SHA512
  9d7f35309fe8b1a7c116639aaea50cc01699787c7afb432389bee2b9ad56a67034c45d90c9585ef1ccf15bdabf0951cbef86257c0c6aedbd2591bbfae3e93b76
  PATCHES
...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  # Install Note: tcl shell requires it to be in a folder adjacent to the /lib/
  # folder, i.e. in a /bin/ folder
  if(NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL release)
    file(GLOB_RECURSE TOOL_BIN "${CURRENT_PACKAGES_DIR}/bin/*.exe"
  ...
  if(NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL debug)
    file(GLOB_RECURSE TOOL_BIN "${CURRENT_PACKAGES_DIR}/debug/bin/*.exe"
         "${CURRENT_PACKAGES_DIR}/debug/bin/*.dll")
    file(COPY ${TOOL_BIN}
         DESTINATION "${CURRENT_PACKAGES_DIR}/tools/tcl/debug/bin/")

    # Remove .exes only after copying
    file(GLOB_RECURSE EXES "${CURRENT_PACKAGES_DIR}/debug/bin/*.exe")
    file(REMOVE ${EXES})

    file(
      REMOVE_RECURSE
      "${CURRENT_PACKAGES_DIR}/debug/lib/dde1.4"
  ...
  file(
    CHMOD_RECURSE
    "${CURRENT_PACKAGES_DIR}/tools/tcl/debug/lib/tcl9.0/msgs"
    "${CURRENT_PACKAGES_DIR}/tools/tcl/debug/lib/tcl9.0/tzdata"
    "${CURRENT_PACKAGES_DIR}/tools/tcl/lib/tcl9.0/msgs"
    "${CURRENT_PACKAGES_DIR}/tools/tcl/lib/tcl9.0/tzdata"
    PERMISSIONS
    OWNER_READ
    OWNER_WRITE
    GROUP_READ
  ...
  vcpkg_configure_make(SOURCE_PATH "${SOURCE_PATH}" PROJECT_SUBPATH unix)
...
file(REMOVE "${CURRENT_PACKAGES_DIR}/lib/tclConfig.sh"
     "${CURRENT_PACKAGES_DIR}/debug/lib/tclConfig.sh")
