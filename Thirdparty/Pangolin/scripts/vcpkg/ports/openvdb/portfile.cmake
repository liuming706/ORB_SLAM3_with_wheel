vcpkg_from_github(
  ...
  REF
  be0e7a78861d2b7d9643f7a0cab04f3ab5951686 # v10.0.0
  SHA512
  92301bf675d700fedb0a2b3c4653158eeda6105e70623e5e4bda15d73391427cf0295a0426204888e2fe062847025542717bff34ceb923e51cffa1721e9d4105
  PATCHES
...
if("tools" IN_LIST FEATURES)
  if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    ...
    message(
      FATAL_ERROR "Unable to build tools if static libraries are required")
  endif()
endif()
...
if("ax" IN_LIST FEATURES)
  if(NOT VCPKG_TARGET_IS_WINDOWS)
    ...
    message(
      FATAL_ERROR "Currently no support for building OpenVDB AX on Windows.")
  endif()
endif()
...
file(
  INSTALL "${SOURCE_PATH}/openvdb/openvdb/COPYRIGHT"
  DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}"
  RENAME copyright)
