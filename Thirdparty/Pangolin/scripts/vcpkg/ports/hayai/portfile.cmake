...
vcpkg_from_github(
  ...
  nickbruun/hayai
  REF
  0234860c7a851362ab33efc6c018203cded3eb48
  SHA512
  e4c65d834eddaeb77e73a3bc24645a531b93d26e32ff1daffbe71c579b76b4b8b4865f6c7ea07b378cafbe2da3a698414d4135f28fc9821eef995ed78d0987f2
  HEAD_REF
  master)
...
if(EXISTS ${CURRENT_PACKAGES_DIR}/debug/lib/hayai_main.lib)
  ...
  file(RENAME ${CURRENT_PACKAGES_DIR}/debug/lib/hayai_main.lib
...
if(EXISTS ${CURRENT_PACKAGES_DIR}/lib/hayai_main.lib)
  ...
  file(RENAME ${CURRENT_PACKAGES_DIR}/lib/hayai_main.lib
