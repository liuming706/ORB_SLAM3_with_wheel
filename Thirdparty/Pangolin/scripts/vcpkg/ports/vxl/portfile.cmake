...
if("core-imaging" IN_LIST FEATURES)
  ...
  if(EXISTS "${CURRENT_INSTALLED_DIR}/include/openjpeg.h")
    ...
    message(
      WARNING
        "Can't build VXL CORE_IMAGING features with non built-in OpenJpeg. Please remove OpenJpeg, and try install VXL again if you need them."
    )
  endif()
endif()
...
vcpkg_from_github(
  ...
  vxl/vxl
  REF
  dac1c7ed8e183e9c6de8b928c8b0294a7bd1d8ee # v2.0.2
  SHA512
  4c6f6dcd793a50cbbc9c7f61c561ed4a747ded67e3dceb09792998c0f0d4294445a441fed668d59297560f196274b1c25593ce67b0aa7597cbb773328e8612c0
  HEAD_REF
  master
  PATCHES
...
vcpkg_cmake_configure(
  ...
  -DVXL_USING_NATIVE_BZLIB2=TRUE # for disable build built-in bzip2
                                 # (v3p/bzlib/CMakeLists.txt#L10-L26)
  ...
  -DVXL_FORCE_V3P_OPENJPEG2=ON # TODO : need fix compile error when using
                               # openjpeg port to turn off
...
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/vxl/cmake/VXLConfig.cmake"
                     "${CURRENT_BUILDTREES_DIR}" "") # only used in comment

file(
  INSTALL "${SOURCE_PATH}/core/vxl_copyright.h"
