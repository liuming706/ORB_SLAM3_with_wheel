if(EXISTS "${CURRENT_INSTALLED_DIR}/include/gmp.h"
  ...
  message(
    FATAL_ERROR
      "Can't build ${PORT} if mpir is installed. Please remove mpir, and try install ${PORT} again if you need it."
  )
endif()
...
vcpkg_download_distfile(
  ...
  FILENAME
  gmp-arm64-asm-fix-5f32dbc41afc.patch
  SHA512
  4a7c50dc0a78e6c297c0ac53129ed367dbf669100a613653987d0eddf175376296254ed26ecce15d02b0544b99e44719af49635e54982b22e745f22e2f8d1eda
)
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  vcpkg_list(APPEND OPTIONS "ac_cv_func_memset=yes" "gmp_cv_asm_w32=.word")
endif()
...
vcpkg_install_copyright(
  FILE_LIST "${SOURCE_PATH}/README" "${SOURCE_PATH}/COPYING.LESSERv3"
  "${SOURCE_PATH}/COPYINGv3" "${SOURCE_PATH}/COPYINGv2")
