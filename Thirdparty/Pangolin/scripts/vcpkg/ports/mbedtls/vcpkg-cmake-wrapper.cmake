...
set(MBEDTLS_LIBRARIES ${MBEDTLS_CRYPTO_LIBRARY} ${MBEDTLS_X509_LIBRARY}
                      ${MBEDTLS_TLS_LIBRARY})
...
if(MBEDTLS_INCLUDE_DIR AND EXISTS "${MBEDTLS_INCLUDE_DIR}/mbedtls/version.h")
  ...
  string(REGEX REPLACE ".*MBEDTLS_VERSION_STRING[\t ]+\"(.*)\"" "\\1"
                       MBEDTLS_VERSION ${_MBEDTLS_VERLINE})
endif()

find_package_handle_standard_args(
  mbedTLS
  REQUIRED_VARS MBEDTLS_INCLUDE_DIR MBEDTLS_CRYPTO_LIBRARY MBEDTLS_X509_LIBRARY
                MBEDTLS_TLS_LIBRARY PThreads4W_FOUND
