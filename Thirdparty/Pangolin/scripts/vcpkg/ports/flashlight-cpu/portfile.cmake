if(EXISTS "${CURRENT_INSTALLED_DIR}/share/flashlight")
  message(
    FATAL_ERROR
      "Only one of flashlight-cpu and flashlight-cuda"
...
vcpkg_from_github(
  ...
  REF
  626914e79073c5547513de649af706f7e2b796ad # 0.3 branch tip
  SHA512
  a22057cfa4cfe7acd95cbc5445a30870cce3cdde89066d1d75f40be0d73b069a49e89b226fe5337488cfe5618dd25958679c0636a3e4008312f01606328becfa
  HEAD_REF
  master
  PATCHES
...
vcpkg_fixup_cmake_targets(CONFIG_PATH share/flashlight TARGET_PATH
                          share/flashlight)
...
if("imgclass" IN_LIST FEATURES)
  list(APPEND FLASHLIGHT_TOOLS fl_img_imagenet_resnet34 fl_img_imagenet_eval
       fl_img_imagenet_vit)
endif()
...
if("lm" IN_LIST FEATURES)
  list(APPEND FLASHLIGHT_TOOLS fl_lm_dictionary_builder fl_lm_train fl_lm_test)
endif()
