...
vcpkg_from_github(
  ...
  Coin3D/simage
  REF
  3940692136e02b9e62b3061cf72f053827b5494e # v1.8.2
  SHA512
  9a39738e32004bdd3e2882fe96778c773758b6d74398a62ba1c5ab09836c0637f89b8a46e8485b9d4196f33864f31f75511f441cfc24d7536659fa610ddf1875
  HEAD_REF
  master
  PATCHES
  requies-all-dependencies.patch)
...
string(COMPARE EQUAL "${VCPKG_CRT_LINKAGE}" "static"
               SIMAGE_USE_MSVC_STATIC_RUNTIME)
...
if(VCPKG_TARGET_IS_WINDOWS AND "gdiplus" IN_LIST FEATURES)
  message(
    WARNING
      "Feature 'gdiplus' will disable feature 'zlib', 'giflib', 'jpeg', 'png' and 'tiff' automaticly."
  )
