if(EXISTS "${CURRENT_INSTALLED_DIR}/share/spdk-isal/copyright")
  message(
    FATAL_ERROR
      "'${PORT}' conflicts with 'spdk-isal'. Please remove spdk-isal:${TARGET_TRIPLET}, and try to install ${PORT}:${TARGET_TRIPLET} again."
  )
endif()
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  ...
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    ...
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
      file(INSTALL "${NMAKE_BINARY_DIR}/isa-l.dll"
           DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
      file(INSTALL "${NMAKE_BINARY_DIR}/isa-l.lib"
           DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
    else()
      file(INSTALL "${NMAKE_BINARY_DIR}/isa-l_static.lib"
           DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
    endif()
  endif()
  ...
  file(INSTALL "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/isa-l.def"
       DESTINATION "${CURRENT_PACKAGES_DIR}/include/isal")
  ...
  vcpkg_configure_make(
    ...
    OPTIONS
    ${options}
    # No rpl_malloc provided, and probably not depending on ‘malloc (0)’
...
configure_file(
  "${CMAKE_CURRENT_LIST_DIR}/unofficial-isal-config.cmake"
  "${CURRENT_PACKAGES_DIR}/share/unofficial-isal/unofficial-isal-config.cmake"
  @ONLY)
configure_file(
  "${CMAKE_CURRENT_LIST_DIR}/isalConfig.cmake"
  "${CURRENT_PACKAGES_DIR}/share/${PORT}/isalConfig.cmake" @ONLY) # legacy
