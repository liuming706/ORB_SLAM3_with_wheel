if(EXISTS "${CURRENT_INSTALLED_DIR}/share/lapack-reference/copyright")
  message(
    FATAL_ERROR
      "Can't build ${PORT} if lapack-reference is installed. Please remove lapack-reference:${TARGET_TRIPLET}, and try to install ${PORT}:${TARGET_TRIPLET} again."
  )
endif()
...
vcpkg_configure_cmake(SOURCE_PATH ${SOURCE_PATH} PREFER_NINJA OPTIONS
                      -DCMAKE_DEBUG_POSTFIX=d ${ARITH_PATH})

vcpkg_install_cmake()
vcpkg_copy_pdbs()

# TODO: fix the official exported targets, since they are broken (luckily it
# seems that no-one uses them for now)
...
file(INSTALL ${CMAKE_CURRENT_LIST_DIR}/FindLAPACK.cmake
     DESTINATION ${CURRENT_PACKAGES_DIR}/share/lapack)
# Handle copyright
file(
