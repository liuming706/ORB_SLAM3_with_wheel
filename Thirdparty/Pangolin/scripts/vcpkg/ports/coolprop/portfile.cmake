...
vcpkg_from_github(
  ...
  CoolProp/CoolProp
  REF
  f5ebb4e655add4c23bb327ab5209f3dbf919bc6d # v6.4.1
  SHA512
  916d00777fe56035171ed0a6cbe09b8d4487317772802e4fe9b43f5965f3212dcb3754e18fe1db9c748a4d17facbbe6cb2244451cf5cf66334465760fc1701b7
  HEAD_REF
  master
  PATCHES
  fmt-fix.patch
...
file(COPY ${CURRENT_INSTALLED_DIR}/include/catch.hpp
...
file(COPY ${CURRENT_INSTALLED_DIR}/include/eigen3/unsupported/Eigen
...
file(COPY ${CURRENT_INSTALLED_DIR}/include/IF97.h
     DESTINATION ${SOURCE_PATH}/externals/IF97)

file(
  COPY ${CURRENT_INSTALLED_DIR}/include/msgpack.h
...
file(COPY ${CURRENT_INSTALLED_DIR}/include/fmt
     DESTINATION ${SOURCE_PATH}/externals/cppformat)

file(COPY ${CURRENT_INSTALLED_DIR}/include/REFPROP_lib.h
     DESTINATION ${SOURCE_PATH}/externals/REFPROP-headers/)

# Use a nasty hack to include the correct header
file(APPEND ${SOURCE_PATH}/externals/msgpack-c/include/fmt/format.h
