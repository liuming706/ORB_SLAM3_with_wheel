...
vcpkg_list(SET CONFIGURE_OPTIONS enable-static-engine enable-capieng no-ssl2
           no-tests)
...
if(VCPKG_TARGET_IS_UWP)
  vcpkg_list(APPEND CONFIGURE_OPTIONS no-unit-test no-asm no-uplink)
...
# Clang always uses /Z7;  Patching /Zi /Fd<Name> out of openssl requires more
# work.
set(OPENSSL_BUILD_MAKES_PDBS ON)
if(VCPKG_DETECTED_CMAKE_C_COMPILER_ID MATCHES "Clang" OR VCPKG_LIBRARY_LINKAGE
                                                         STREQUAL "static")
...
vcpkg_build_nmake(
  ...
  OPTIONS_RELEASE
  install_runtime
  install_ssldirs # extra targets
)

file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
file(RENAME "${CURRENT_PACKAGES_DIR}/openssl.cnf"
     "${CURRENT_PACKAGES_DIR}/tools/${PORT}/openssl.cnf")
if(NOT VCPKG_TARGET_IS_UWP)
  foreach(script IN ITEMS "bin/c_rehash.pl" "misc/CA.pl" "misc/tsget.pl")
    file(COPY "${CURRENT_PACKAGES_DIR}/${script}"
         DESTINATION "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
    file(REMOVE "${CURRENT_PACKAGES_DIR}/${script}"
         "${CURRENT_PACKAGES_DIR}/debug/${script}")
  endforeach()
