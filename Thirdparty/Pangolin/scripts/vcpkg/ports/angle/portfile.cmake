...
vcpkg_from_github(
  ...
  google/angle
  REF
  d15be77864e18f407c317be6f6bc06ee2b7d070a # chromium/4472
  SHA512
  aad8563ee65458a7865ec7c668d1f90ac2891583c569a22dcd2c557263b72b26386f56b74a7294398be2cf5c548df513159e4be53f3f096f19819ca06227d9ac
...
file(COPY "${CMAKE_CURRENT_LIST_DIR}/angle_commit.h"
     DESTINATION "${SOURCE_PATH}")
file(COPY "${CMAKE_CURRENT_LIST_DIR}/angle_commit.h"
...
checkout_in_path_with_patches(
  ...
  "09490503d0f201b81e03f5ca0ab8ba8ee76d4a8e" "third-party-zlib-far-undef.patch")
...
vcpkg_cmake_config_fixup(CONFIG_PATH share/unofficial-angle PACKAGE_NAME
                         unofficial-angle)
...
# angle defines some additional entrypoints. opengl-registry probably needs an
# upstream update to account for those Due to that all angle headers get moved
# to include/angle. If you want to use those instead of the onces provided by
# opengl-registry make sure VCPKG_INSTALLED_DIR/include/angle is before
