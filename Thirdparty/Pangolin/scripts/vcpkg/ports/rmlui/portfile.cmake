vcpkg_from_github(
  ...
  5.0
  SHA512
  10136893eb695b098fe6d718e23ce331c549faf3eb73413a5bb143ddd3601726b8bc42382c4e575d2abfff838ad3e6af1d4945426223a9c6f0fd048b481819dd
  HEAD_REF
  master
  PATCHES
...
vcpkg_check_features(
  ...
  INVERTED_FEATURES
  freetype
  NO_FONT_INTERFACE_DEFAULT)

# Remove built-in header, instead we use vcpkg version (from robin-hood-hashing
# port)
...
file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/debug/include
     ${CURRENT_PACKAGES_DIR}/debug/lib/RmlUi ${CURRENT_PACKAGES_DIR}/lib/RmlUi)

if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  vcpkg_replace_string(${CURRENT_PACKAGES_DIR}/include/RmlUi/Core/Header.h
                       "#if !defined RMLUI_STATIC_LIB" "#if 0")
