...
vcpkg_from_github(
  ...
  v4.1.4
  SHA512
  8f35e757dddc27c9b11cdb3b9920562bbe09ceac715d65957e56ec8479e8ffedf12df2f976e484ed0d24b9325d9ef2b8ad6576cccefd2de8d7fa6fa8d58b03e5
  HEAD_REF
  master
  PATCHES
  001-arm64-support.patch
  support-arm64-osx.diff # from
                         # https://github.com/NordicSemiconductor/pc-ble-driver/pull/271
)

# Ensure that git is found within CMakeLists.txt by appending vcpkg's git
# executable dirpath to $PATH. Git should always be available as it is
# downloaded during the bootstrap phase. Append instead of prepend to $PATH to
# honor the user's git executable as a general rule.
...
foreach(HEX_DIR IN ITEMS "sd_api_v2" "sd_api_v3" "sd_api_v5" "sd_api_v6")
  ...
  file(INSTALL "${SOURCE_PATH}/hex/${HEX_DIR}"
