...
#
# ``CXSparse_FOUND`` True if CXSparse found on the local system
#
# ``CXSPARSE_FOUND`` True if CXSparse found on the local system
#
# ``CXSparse_INCLUDE_DIRS`` Location of CXSparse header files
#
# ``CXSPARSE_INCLUDE_DIRS`` Location of CXSparse header files
#
# ``CXSparse_LIBRARIES`` List of the CXSparse libraries found
#
# ``CXSPARSE_LIBRARIES`` List of the CXSparse libraries found
#
...
if(CXSPARSE_INCLUDE_DIR)
  ...
  string(REGEX MATCH "#define CS_SUBVER [0-9]+" CXSPARSE_SUB_VERSION
               "${CXSPARSE_VERSION_FILE_CONTENTS}")
  string(REGEX REPLACE "#define CS_SUBVER ([0-9]+)" "\\1" CXSPARSE_SUB_VERSION
