vcpkg_from_github(
  ...
  apache/orc
  REF
  7ff749a4234c3db58d272a8fc1c7cc1860245692 # rel/release-1.7.6
  SHA512
  1e7f0366530b691d7ea7ce671aa1e1a655cde2feb0fb0c3639da36ef565aceaf6f05e49a39c3c0ab7417dc324dc2cbb6e8babbf21f899ccb4cf5f0e63217afbf
  HEAD_REF
  master
  PATCHES
...
set(PROTOBUF_EXECUTABLE
    "${CURRENT_HOST_INSTALLED_DIR}/tools/protobuf/protoc${VCPKG_HOST_EXECUTABLE_SUFFIX}"
)

if(VCPKG_TARGET_IS_WINDOWS)
  set(BUILD_TOOLS OFF)
  # when cross compiling, we can't run their test. however: - Windows doesn't
  # support time_t < 0 => HAS_PRE_1970 test returns false - Windows doesn't
  # support setenv => HAS_POST_2038 test fails to compile
