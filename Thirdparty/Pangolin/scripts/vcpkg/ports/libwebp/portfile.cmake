vcpkg_from_github(
  ...
  v1.2.4
  SHA512
  85c7d2bd1697ed6f18d565056d0105edd63697f144d2c935e9c0563ff09f4acc56d4ac509668f920e8d5dc3c74b53a42f65265fc758fed173cb2168c4d6a551c
  HEAD_REF
  master
  PATCHES
...
if(VCPKG_TARGET_IS_OSX)
  if("vwebp" IN_LIST FEATURES OR "extras" IN_LIST FEATURES)
    message(
      FATAL_ERROR
        "Due to GLUT Framework problems with CMake, at the moment it's not possible to build VWebP or extras on Mac!"
    )
  endif()
endif()
...
foreach(tool ${BIN_NAMES})
  ...
  if(EXISTS
    ...
    file(
      RENAME
      "${CURRENT_PACKAGES_DIR}/bin/${tool}${VCPKG_TARGET_EXECUTABLE_SUFFIX}"
      "${CURRENT_PACKAGES_DIR}/tools/webp/${tool}${VCPKG_TARGET_EXECUTABLE_SUFFIX}"
    )
  endif()
endforeach()
