vcpkg_download_distfile(
  ...
  FILENAME
  "QScintilla-2.12.0.tar.gz"
  SHA512
  9bdaba5c33c1b11ccad83eb1fda72142758afc50c955a62d5a8ff102b41d4b67d897bf96ce0540e16bc5a7fae2ce1acbf06931d5f0ae6768759c9ff072c03daa
)
...
vcpkg_configure_qmake(SOURCE_PATH ${SOURCE_PATH}/src OPTIONS CONFIG+=build_all
...
if(VCPKG_TARGET_IS_WINDOWS AND (VCPKG_LIBRARY_LINKAGE STREQUAL dynamic))
  vcpkg_replace_string(${CURRENT_PACKAGES_DIR}/include/Qsci/qsciglobal.h
                       "#if defined(QSCINTILLA_DLL)" "#if 1")
endif()
