...
vcpkg_from_github(
  ...
  SHA512
  779983bd0aac1f281bf357d0218e9626a5c72c3391513eef8a56148f08966f3cc75495e97f410ea7156d40be16977b5c64748c66626ae6d877e2a6c28dc822a2
  HEAD_REF
  master
  PATCHES
  outdir.patch
...
file(
  RENAME
  "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/${SOURCE_PATH_SUFFIX}/msvc/include"
...
configure_file("${SOURCE_PATH}/src/gpg-error.pc.in"
               "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/gpg-error.pc" @ONLY)
...
configure_file("${SOURCE_PATH}/src/gpg-error.pc.in"
               "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/gpg-error.pc" @ONLY)
