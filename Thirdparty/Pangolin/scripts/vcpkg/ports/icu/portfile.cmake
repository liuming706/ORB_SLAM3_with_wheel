...
vcpkg_download_distfile(
  ARCHIVE
  URLS
  "https://github.com/unicode-org/icu/releases/download/release-${VERSION3}/icu4c-${VERSION2}-src.tgz"
  FILENAME
  "icu4c-${VERSION2}-src.tgz"
  SHA512
...
vcpkg_extract_source_archive_ex(
  ...
  disable-static-prefix.patch # https://gitlab.kitware.com/cmake/cmake/-/issues/16617;
                              # also mingw.
  fix-win-build.patch
...
list(APPEND CONFIGURE_OPTIONS --disable-samples --disable-tests
     --disable-layoutex)
...
if(CMAKE_HOST_WIN32
   AND VCPKG_TARGET_IS_MINGW
   AND NOT HOST_TRIPLET MATCHES "mingw")
...
if(VCPKG_TARGET_IS_OSX
   ...
   AND (NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release"))

  vcpkg_build_make()
  # remove this block if https://unicode-org.atlassian.net/browse/ICU-21458 is
  # resolved and use the configure script instead
  ...
  find_program(
    ...
    DOC "Absolute path of install_name_tool" REQUIRED)
  ...
  foreach(LIB_NAME libicudata libicui18n libicuio libicutu libicuuc)
    vcpkg_execute_build_process(
      ...
      ${INSTALL_NAME_TOOL}
      -id
      "${ID_PREFIX}/${LIB_NAME}.${ICU_VERSION_MAJOR}.dylib"
      "${LIB_NAME}.${VERSION}.dylib"
      WORKING_DIRECTORY
      "${CURRENT_BUILDTREES_DIR}/${RELEASE_TRIPLET}/lib"
      LOGNAME
      "make-build-fix-rpath-${RELEASE_TRIPLET}")
  endforeach()
  ...
  foreach(LIB_NAME libicui18n libicuio)
    vcpkg_execute_build_process(
      ...
      ${INSTALL_NAME_TOOL}
      -change
      "libicuuc.${ICU_VERSION_MAJOR}.dylib"
    ...
    vcpkg_execute_build_process(
      ...
      ${INSTALL_NAME_TOOL}
      -change
      "libicudata.${ICU_VERSION_MAJOR}.dylib"
  ...
  foreach(LIB_NAME libicuio libicutu)
    vcpkg_execute_build_process(
      ...
      ${INSTALL_NAME_TOOL}
      -change
      "libicui18n.${ICU_VERSION_MAJOR}.dylib"
...
file(GLOB TEST_LIBS "${CURRENT_PACKAGES_DIR}/lib/*test*"
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  ...
  foreach(HEADER utypes.h utf_old.h platform.h)
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/unicode/${HEADER}"
                         "defined(U_STATIC_IMPLEMENTATION)" "1")
  endforeach()
endif()

# Install executables from /tools/icu/sbin to /tools/icu/bin on unix (/bin
# because icu require this for cross compiling)
...
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/tools/icu/sbin"
...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
  file(GLOB DEBUG_DLLS
       "${CURRENT_PACKAGES_DIR}/debug/lib/*icu*${ICU_VERSION_MAJOR}.dll")
  file(COPY ${DEBUG_DLLS} DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
endif()

# remove any remaining dlls in /lib
file(GLOB DUMMY_DLLS "${CURRENT_PACKAGES_DIR}/lib/*.dll"
...
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/icu/bin/icu-config"
