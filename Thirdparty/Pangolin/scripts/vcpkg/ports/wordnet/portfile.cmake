...
vcpkg_download_distfile(
  ARCHIVE
  URLS
  "http://wordnetcode.princeton.edu/${VERSION}/WordNet-${VERSION}.tar.gz"
  FILENAME
  "wordnet-${VERSION}.tar.gz"
  SHA512
  9539bc016d710f31d65072bbf5068edffcd735978d8cc6f1b361b19428b97546ef6c7e246e1b6f2ff4557a0885a8305341e35173a6723f0740dda18d097ca248
)
...
file(COPY ${CMAKE_CURRENT_LIST_DIR}/wordnet-config.cmake.in
     DESTINATION ${SOURCE_PATH})

if("dbfiles" IN_LIST FEATURES)
  vcpkg_download_distfile(
    WORDNET_DICT_DBFILES
    URLS
    "http://wordnetcode.princeton.edu/wn3.1.dict.tar.gz"
    FILENAME
    "wordnet-cache/wn3.1.dict.tar.gz"
    SHA512
...
vcpkg_configure_cmake(SOURCE_PATH ${SOURCE_PATH} PREFER_NINJA OPTIONS
                      -DWORDNET_DICT_PATH=${WORDNET_DICT_PATH})
...
file(
  ...
  DESTINATION ${CURRENT_PACKAGES_DIR}/share/wordnet
  RENAME copyright)
