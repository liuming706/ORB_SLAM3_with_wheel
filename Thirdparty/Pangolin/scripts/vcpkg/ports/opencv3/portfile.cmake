...
vcpkg_from_github(
  ...
  ${OPENCV_VERSION}
  SHA512
  96bbeb9525325f17ba635a0b75126aae0a7b0daef211af45057a97abd5d31a57fc50f0e889a6dab614df9b7621a145e06c0d240f0a218f33df1217d9a19c510d
  HEAD_REF
  master
  PATCHES
...
if("contrib" IN_LIST FEATURES)
  if(VCPKG_TARGET_IS_UWP)
    ...
    message(
      WARNING
        "The image quality module (quality) does not build for UWP, the module has been disabled."
    )
  ...
  vcpkg_from_github(
    ...
    ${OPENCV_VERSION}
    SHA512
    a051497e61ae55f86c224044487fc2247a3bba1aa27031c4997c981ddf8402edf82f1dd0d307f562c638bc021cfd8bd42a723973f00ab25131495f84d33c5383
    HEAD_REF
    master
    PATCHES
    0007-fix-hdf5.patch
  ...
  function(download_opencv_3rdparty ID COMMIT HASH)
    if(NOT EXISTS "${DOWNLOADS}/opencv-cache/${ID}/${COMMIT}.stamp")
      vcpkg_download_distfile(
        OCV_DOWNLOAD
        URLS
        "https://github.com/opencv/opencv_3rdparty/archive/${COMMIT}.zip"
        FILENAME
        "opencv_3rdparty-${COMMIT}.zip"
        SHA512
        ${HASH})
      ...
      foreach(FILE ${XFEATURES2D_I})
        ...
        file(
          RENAME "${DOWNLOADS}/opencv-cache/${ID}/${XFEATURES2D_I_NAME}"
          "${DOWNLOADS}/opencv-cache/${ID}/${FILE_HASH}-${XFEATURES2D_I_NAME}")
      endforeach()
...
if(NOT VCPKG_BUILD_TYPE)
  ...
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/opencv3/OpenCVModules-debug.cmake"
    "\${_IMPORT_PREFIX}/sdk" "\${_IMPORT_PREFIX}/debug/sdk")
endif()

if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  file(READ "${CURRENT_PACKAGES_DIR}/share/opencv3/OpenCVModules.cmake"
       OPENCV_MODULES)
  set(DEPS_STRING
...
find_dependency(Qt${USE_QT_VERSION} COMPONENTS OpenGL)")
  ...
  file(WRITE "${CURRENT_PACKAGES_DIR}/share/opencv3/OpenCVModules.cmake"
       "${OPENCV_MODULES}")
