...
vcpkg_from_github(
  ...
  REF
  51d00a28d761b7ae1585ee554a55fd8e6b943c9a # CRYPTOPP_8_7_0
  SHA512
  cd4d6ea6b33495dd63f4204c45c6cc2a850f26d36465b7edfcca359eb7b6a3623b6116d2ab44da311cbf1dbbcb9731ab78a94fce21eb162c9773e4bf191f669a
  HEAD_REF
  master)
...
vcpkg_from_github(
  ...
  weidai11/cryptopp
  REF
  511806c0eba8ba5b5cedd4b4a814e96df92864a6 # CRYPTOPP_8_7_0
  SHA512
  9d26299c6a55b32a790190c1e1dcbd9a93abc0c2a997714cb7c3a53daf9e142ba54afbd1fbaf86029dfc80d4687fd296dde589440ead07278499478d262a1483
  HEAD_REF
  master
  PATCHES
  patch.patch)
...
file(COPY "${CMAKE_SOURCE_PATH}/cryptopp/cryptoppConfig.cmake"
...
if("pem-pack" IN_LIST FEATURES)
  vcpkg_from_github(
    OUT_SOURCE_PATH
    PEM_PACK_SOURCE_PATH
    REPO
    noloader/cryptopp-pem
    REF
    095f08ff2ef9bca7b81036a59f2395e4f08ce2e8
    SHA512
    49912758a635faca1f49665ac9552b20576b46e0283aaabc19bb012bdc80586106452018e5088b9b46967717982ca6022ca968edc4cac96a7506d2b1a3e4bf13
    HEAD_REF
    master)

  file(GLOB PEM_PACK_FILES ${PEM_PACK_SOURCE_PATH}/*.h
       ${PEM_PACK_SOURCE_PATH}/*.cpp)
  file(INSTALL ${PEM_PACK_FILES}
...
# so generate a static lib for both dynamic and static vcpkg targets. See also:
...
vcpkg_cmake_configure(
  ...
  -DCMAKE_POLICY_DEFAULT_CMP0063=NEW # Honor "<LANG>_VISIBILITY_PRESET"
                                     # properties
...
# There is no way to suppress installation of the headers and resource files in
# debug build.
