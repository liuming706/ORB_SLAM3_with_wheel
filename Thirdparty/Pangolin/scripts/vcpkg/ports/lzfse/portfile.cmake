...
vcpkg_from_github(
  ...
  lzfse-1.0
  SHA512
  9d7ca44e6d3d2bdf4b82b0eb66c14922369b8b6fe2cf891187a77c6708b8d26c2c1b2ccddec6059e85dbbbb37c497419549f02812b5f34d06238ac246a8cf912
  HEAD_REF
  master
  PATCHES
...
vcpkg_configure_cmake(SOURCE_PATH ${SOURCE_PATH} PREFER_NINJA OPTIONS
                      -DLZFSE_DISABLE_TESTS=ON -DLZFSE_DISABLE_CLI=ON)
...
file(COPY ${SOURCE_PATH}/LICENSE
     DESTINATION ${CURRENT_PACKAGES_DIR}/share/lzfse)
file(RENAME ${CURRENT_PACKAGES_DIR}/share/lzfse/LICENSE
     ${CURRENT_PACKAGES_DIR}/share/lzfse/copyright)
