...
vcpkg_from_github(
  ...
  v2.1.1
  SHA512
  62BBB965EA4BF1D416ED78231B1BA4B41C0F46327D7BE16D1F98095DB63EF0E0D893B70040009711BC9C68555B1B8C4038F5032ABD66B759E955E2CBB0553EC3
  HEAD_REF
  master)

# TODO: check SSE and AVX availability and set corresponding tags
vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}/similarity_search")
...
foreach(HEADER ${HEADERS})
  string(REPLACE "${CURRENT_PACKAGES_DIR}/include"
                 "${CURRENT_PACKAGES_DIR}/include/nmslib" MOVED_HEADER
                 "${HEADER}")
