vcpkg_from_github(
  ...
  emweb/wt
  REF
  402c55d196da761ec982beabaf11a8675fa76518 # 4.8.1
  SHA512
  de89e0de17bcfa142b9e94fde2b398b26046ecb66ef9ab673cd278e1d60a366965d3de524884f17a54ab65ffdc5d9ade5f8df457d3ff157af214476fe1285140
  HEAD_REF
  master
  PATCHES
...
if(VCPKG_TARGET_IS_WINDOWS)
  set(WT_PLATFORM_SPECIFIC_OPTIONS -DWT_WRASTERIMAGE_IMPLEMENTATION=Direct2D
                                   -DCONNECTOR_ISAPI=ON -DENABLE_PANGO=OFF)
else()
  set(WT_PLATFORM_SPECIFIC_OPTIONS
      -DCONNECTOR_FCGI=OFF -DENABLE_PANGO=ON
...
# RUNDIR is only used for wtfcgi what we don't build. See
# https://redmine.webtoolkit.eu/issues/9646
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/Wt/WConfig.h"
                     "#define RUNDIR \"${CURRENT_PACKAGES_DIR}/var/run/wt\"" "")
