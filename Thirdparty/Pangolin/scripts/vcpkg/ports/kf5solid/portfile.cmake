vcpkg_from_github(
  ...
  v5.98.0
  SHA512
  9f0aed7f8ea29a6132ca9c99c4c744ca5580bb3f7be1712e27d1fc3ae47b2edac26a5ce20abddef4d9998612f2386e1cc6915504c02897f2b3ebcec01cd26208
  HEAD_REF
  master
  PATCHES
  fix-libmount.patch)
...
if(VCPKG_TARGET_IS_OSX)
  ...
  if(NOT (BISON_MAJOR GREATER_EQUAL 3 AND BISON_MINOR GREATER_EQUAL 0))
    message(
      WARNING
        "${PORT} requires bison version greater than one provided by macOS, please use \`brew install bison\` to install a newer bison."
    )
  endif()
endif()
...
vcpkg_cmake_configure(
  SOURCE_PATH "${SOURCE_PATH}" OPTIONS -DBUILD_DEVICE_BACKEND_imobile=OFF
  -DBUILD_TESTING=OFF -DKDE_INSTALL_QMLDIR=qml)

vcpkg_cmake_install()
vcpkg_cmake_config_fixup(PACKAGE_NAME KF5Solid CONFIG_PATH lib/cmake/KF5Solid)
vcpkg_copy_pdbs()

vcpkg_copy_tools(TOOL_NAMES solid-hardware5 AUTO_CLEAN)
