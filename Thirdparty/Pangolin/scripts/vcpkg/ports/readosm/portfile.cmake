...
vcpkg_download_distfile(
  ARCHIVE
  URLS
  "https://www.gaia-gis.it/gaia-sins/readosm-sources/readosm-${READOSM_VERSION_STR}.tar.gz"
  FILENAME
  "readosm-${READOSM_VERSION_STR}.tar.gz"
  SHA512
  ec8516cdd0b02027cef8674926653f8bc76e2082c778b02fb2ebcfa6d01e21757aaa4fd5d5104059e2f5ba97190183e60184f381bfd592a635805aa35cd7a682
)

vcpkg_extract_source_archive(SOURCE_PATH ARCHIVE "${ARCHIVE}" PATCHES
                             fix-makefiles.patch pc-file.patch)

set(PKGCONFIG_MODULES expat zlib)

if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  x_vcpkg_pkgconfig_get_modules(PREFIX PKGCONFIG MODULES --msvc-syntax
                                ${PKGCONFIG_MODULES} LIBS)
  ...
  if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    ...
    file(RENAME "${CURRENT_PACKAGES_DIR}/lib/readosm_i.lib"
         "${CURRENT_PACKAGES_DIR}/lib/readosm.lib")
    if(NOT DEFINED VCPKG_BUILD_TYPE)
      file(REMOVE "${CURRENT_PACKAGES_DIR}/debug/lib/readosm.lib")
      file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/readosm_i.lib"
           "${CURRENT_PACKAGES_DIR}/debug/lib/readosm.lib")
    endif()
  endif()
  ...
  x_vcpkg_pkgconfig_get_modules(PREFIX PKGCONFIG MODULES ${PKGCONFIG_MODULES}
                                LIBS)
