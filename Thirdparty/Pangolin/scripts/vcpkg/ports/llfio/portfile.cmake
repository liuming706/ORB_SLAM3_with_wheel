...
vcpkg_from_github(
  ...
  ned14/llfio
  REF
  6c8e3e10a2919b4da754d0f3db54b3c616e1dd56
  SHA512
  9265d722a6d9e4a9a0605fc071c5053bd71188f6d5500cfa4e64ef9ee33be364d3a1289d011863b64a4f3bdfc3a54fa9bfc6ee69ff1a93995584605c58e79f62
  HEAD_REF
  develop
  PATCHES)
...
vcpkg_from_github(
  ...
  REF
  bbd44623594142155d49bd3ce8820d3cf9da1e1e
  SHA512
  589d3bc7bca98ca8d05ce9f5cf009dd98b8884bdf3739582f2f6cbf5a324ce95007ea041450ed935baa4a401b4a0242c181fb6d2dcf7ad91587d75f05491f50e
  HEAD_REF
  master)

vcpkg_check_features(OUT_FEATURE_OPTIONS LLFIO_FEATURE_OPTIONS FEATURES
...
file(RENAME "${NTKEC_SOURCE_PATH}"
     "${SOURCE_PATH}/include/llfio/ntkernel-error-category")

set(extra_config)
# cmake does not correctly set CMAKE_SYSTEM_PROCESSOR when targeting ARM on
# Windows
...
# setting CMAKE_CXX_STANDARD here to prevent llfio from messing with compiler
...
# quickcpplib parses CMAKE_MSVC_RUNTIME_LIBRARY and cannot support the default
# crt linkage generator expression from vcpkg
...
vcpkg_cmake_configure(
  ...
  -DLLFIO_ENABLE_DEPENDENCY_SMOKE_TEST=ON # Leave this always on to test
                                          # everything compiles
...
if("status-code" IN_LIST FEATURES)
  file(INSTALL "${CURRENT_PORT_DIR}/usage-status-code-${VCPKG_LIBRARY_LINKAGE}"
       DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}")
else()
  file(INSTALL "${CURRENT_PORT_DIR}/usage-error-code-${VCPKG_LIBRARY_LINKAGE}"
       DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}")
endif()
