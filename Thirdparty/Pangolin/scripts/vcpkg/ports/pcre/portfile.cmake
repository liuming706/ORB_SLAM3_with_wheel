...
foreach(FILE "${CURRENT_PACKAGES_DIR}/include/pcre.h"
             "${CURRENT_PACKAGES_DIR}/include/pcreposix.h")
...
file(REMOVE "${CURRENT_PACKAGES_DIR}/bin/pcre-config"
     "${CURRENT_PACKAGES_DIR}/debug/bin/pcre-config")
...
vcpkg_copy_pdbs()
configure_file(
  "${CMAKE_CURRENT_LIST_DIR}/unofficial-pcre-config.cmake"
  "${CURRENT_PACKAGES_DIR}/share/unofficial-pcre/unofficial-pcre-config.cmake"
  @ONLY)
