...
vcpkg_from_github(
  ...
  ezEngine/ezEngine
  REF
  1448308ab99bae0d8d2a292ad345ff3a757f3124 # 21.10
  SHA512
  20da87772366d1612795f534b31600123c0d04beba252d27d895c3c3cff7dae65952bd890629d79a7a691c2f3444601552c4b4eca99e8f8a99dc935ce2ebd284
  PATCHES
...
# EzEngine does not support CMake-based install; copy headers and libraries
# manually.
file(
  GLOB_RECURSE FOUNDATION_INCLUDE_FILES
  RELATIVE "${SOURCE_PATH}/Code/Engine/Foundation"
  "${SOURCE_PATH}/Code/Engine/Foundation/*.h")
foreach(SOURCE_FILE ${FOUNDATION_INCLUDE_FILES})
  ...
  if(SOURCE_FILE_DIR STREQUAL "")
    ...
    set(TARGET_DIR
        "${CURRENT_PACKAGES_DIR}/include/Foundation/${SOURCE_FILE_DIR}")
  endif()
  file(COPY "${SOURCE_PATH}/Code/Engine/Foundation/${SOURCE_FILE}"
       DESTINATION "${TARGET_DIR}")
endforeach()

if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL debug)
  set(LIB_SOURCE_DIR
      "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/Output/Lib")
...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL release)
  set(LIB_SOURCE_DIR
      "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/Output/Lib")
