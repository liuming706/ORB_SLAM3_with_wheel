...
vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}" OPTIONS -DTBB_TEST=OFF
                      -DTBB_STRICT=OFF)
...
file(
  ...
  # These are duplicate libraries provided on Windows -- users should use the
  # tbb12 libraries instead
...
file(
  WRITE "${CURRENT_PACKAGES_DIR}/share/tbb/TBBConfig.cmake"
  "
