vcpkg_from_github(
  ...
  release-1.0.22
  SHA512
  fe3c393c2d11981b42355acd8dbc337727120bcd0ff595abac1975c4ce5f68bb74a9a1b4c959e64e9a847ae5d504100d31979ffd7d9702c55b2dbd889de17d3e
  HEAD_REF
  master
  PATCHES
...
vcpkg_from_github(
  ...
  release-1.0.22
  SHA512
  92802d57a45ca1d697d3cea1b3f5619af4ba36156cb28c2c39b2295a74ebc45907caf371c916c54ec3be44a2f3ae447ffc1cd62f54b7b24f7a081408328c7651
  HEAD_REF
  master
  PATCHES
  fix-openxr-sdk-jsoncpp.patch
...
# Weird behavior inside the OpenXR loader.  On Windows they force shared
# libraries to use static crt, and vice-versa. Might be better in future
# iterations to patch the CMakeLists.txt for OpenXR
...
foreach(HEADER ${HEADER_LIST})
  vcpkg_execute_required_process(
    COMMAND
    ${PYTHON3}
    "${HPP_SOURCE_PATH}/scripts/hpp_genxr.py"
    -registry
    "${SDK_SOURCE_PATH}/specification/registry/xr.xml"
    -o
    "${CURRENT_PACKAGES_DIR}/include/openxr"
    ${HEADER}
    WORKING_DIRECTORY
    "${HPP_SOURCE_PATH}"
    LOGNAME
