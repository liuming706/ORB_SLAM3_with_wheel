vcpkg_from_github(
  ...
  v1.0.2
  SHA512
  ccd62f6b1ca55035a08660052f38e73866260d5295490864fa9c86af779a42ce2ec727d6c88f0ea38f205903cf8f4107069b690849e432219c74d3b9666e3ae2
  HEAD_REF
  develop
  PATCHES
  0001-fix-osx.patch
  0002-find-tbb.patch # Includes changes similar to
                      # https://github.com/alicevision/CCTag/pull/178/
)

file(REMOVE "${SOURCE_PATH}/cmake/FindTBB.cmake"
     "${SOURCE_PATH}/src/applications/cmake/FindTBB.cmake")
...
vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}" OPTIONS
                      -DCCTAG_BUILD_TESTS:BOOL=OFF ${FEATURE_OPTIONS})
...
# remove test files
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/include/cctag/geometry/test"
     "${CURRENT_PACKAGES_DIR}/include/cctag/test")
# remove cuda headers
