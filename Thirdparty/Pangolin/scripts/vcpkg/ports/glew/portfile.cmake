if(VCPKG_TARGET_IS_LINUX)
  message(
    WARNING
      "${PORT} requires the following libraries from the system package manager:\n    libxmu-dev\n    libxi-dev\n    libgl-dev\n\nThese can be installed on Ubuntu systems via apt-get install libxmu-dev libxi-dev libgl-dev."
  )
endif()

# Don't change to vcpkg_from_github! The sources in the git repository
# (archives) are missing some files that are distributed inside releases. More
# info: https://github.com/nigels-com/glew/issues/31 and
...
vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}/build/cmake"
                      DISABLE_PARALLEL_CONFIGURE OPTIONS -DBUILD_UTILS=OFF)
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  ...
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    list(APPEND _targets_cmake_files
         "${CURRENT_PACKAGES_DIR}/share/glew/glew-targets-debug.cmake")
  endif()
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    list(APPEND _targets_cmake_files
         "${CURRENT_PACKAGES_DIR}/share/glew/glew-targets-release.cmake")
  endif()
  ...
  if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/libglew32.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/lib/libglew32.lib"
         "${CURRENT_PACKAGES_DIR}/lib/glew32.lib")
  endif()
  if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/libglew32d.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/libglew32d.lib"
         "${CURRENT_PACKAGES_DIR}/debug/lib/glew32d.lib")
  endif()
endif()
