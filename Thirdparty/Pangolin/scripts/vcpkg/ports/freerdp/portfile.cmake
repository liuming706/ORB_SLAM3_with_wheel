...
vcpkg_cmake_configure(
  SOURCE_PATH "${SOURCE_PATH}" OPTIONS ${FREERDP_CRT_LINKAGE}
  ${FREERDP_WITH_CLIENT} ${FEATURE_OPTIONS})
...
foreach(PACKAGE FreeRDP-Client2 FreeRDP2 WinPR2)
  ...
  file(RENAME "${CURRENT_PACKAGES_DIR}/lib/cmake/${PACKAGE}"
       "${CURRENT_PACKAGES_DIR}/lib/cmake/${PACKAGE}_temp/${PACKAGE}")
  if(NOT VCPKG_BUILD_TYPE)
    file(MAKE_DIRECTORY
         "${CURRENT_PACKAGES_DIR}/debug/lib/cmake/${PACKAGE}_temp")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/cmake/${PACKAGE}"
         "${CURRENT_PACKAGES_DIR}/debug/lib/cmake/${PACKAGE}_temp/${PACKAGE}")
  endif()
endforeach()

vcpkg_cmake_config_fixup(
  CONFIG_PATH lib/cmake/FreeRDP-Client2_temp/FreeRDP-Client2 PACKAGE_NAME
  FreeRDP-Client)
vcpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/FreeRDP2_temp/FreeRDP2
                         PACKAGE_NAME FreeRDP)
vcpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/WinPR2_temp/WinPR2 PACKAGE_NAME
                         WinPR)
...
if(NOT VCPKG_BUILD_TYPE)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/WinPR/WinPRTargets-debug.cmake"
...
vcpkg_replace_string(
  "${CURRENT_PACKAGES_DIR}/share/WinPR/WinPRTargets-release.cmake"
...
file(
  ...
  "${CURRENT_PACKAGES_DIR}/debug/lib/cmake" "${CURRENT_PACKAGES_DIR}/lib/cmake")

vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/freerdp/build-config.h"
