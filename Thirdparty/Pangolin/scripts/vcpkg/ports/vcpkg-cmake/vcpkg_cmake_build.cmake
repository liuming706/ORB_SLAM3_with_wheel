...
function(vcpkg_cmake_build)
  ...
  if(DEFINED arg_UNPARSED_ARGUMENTS)
    message(
      FATAL_ERROR
        "vcpkg_cmake_build was passed extra arguments: ${arg_UNPARSED_ARGUMENTS}"
    )
  endif()
  ...
  elseif(Z_VCPKG_CMAKE_GENERATOR STREQUAL "Xcode")
    ...
    message(
      WARNING "Unrecognized GENERATOR setting from vcpkg_cmake_configure().")
  endif()
    ...
    if(NOT DEFINED VCPKG_BUILD_TYPE OR "${VCPKG_BUILD_TYPE}" STREQUAL
      ...
      if(arg_DISABLE_PARALLEL)
        vcpkg_execute_build_process(
          ...
          LOGNAME
          "${arg_LOGFILE_BASE}-${TARGET_TRIPLET}-${short_build_type}")
      else()
        vcpkg_execute_build_process(
          COMMAND
          "${CMAKE_COMMAND}"
