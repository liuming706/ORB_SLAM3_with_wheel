...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  # Clear
  vcpkg_execute_required_process(COMMAND "devenv.exe" "nmap.sln" /Clean
  ...
  # Build
  vcpkg_build_msbuild(PROJECT_PATH ${SOURCE_PATH}/mswin32/nmap.vcxproj PLATFORM
                      ${MSBUILD_PLATFORM} USE_VCPKG_INTEGRATION)
  ...
  set(OPTIONS
      ...
      --with-libpcre=${CURRENT_INSTALLED_DIR})
  message(STATUS "Building Options: ${OPTIONS}")

  # Since nmap makefile has strong relationshop with codes, copy codes to obj
  # path
  message(STATUS "Configuring ${TARGET_TRIPLET}-rel")
  vcpkg_extract_source_archive(
    source_path_release ARCHIVE "${ARCHIVE}" WORKING_DIRECTORY
  ...
  vcpkg_execute_required_process(
    COMMAND make WORKING_DIRECTORY "${source_path_release}" LOGNAME
    build-${TARGET_TRIPLET}-rel)

  message(STATUS "Installing ${TARGET_TRIPLET}-rel")
  file(INSTALL "${source_path_release}/nmap"
       DESTINATION "${CURRENT_PACKAGES_DIR}/tools")
  ...
  if(NOT VCPKG_BUILD_TYPE)
    ...
    vcpkg_extract_source_archive(
      source_path_debug ARCHIVE "${ARCHIVE}" WORKING_DIRECTORY
      "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel")
    ...
    vcpkg_execute_required_process(
      COMMAND make WORKING_DIRECTORY ${source_path_debug} LOGNAME
