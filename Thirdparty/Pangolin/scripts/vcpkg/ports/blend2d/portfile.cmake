vcpkg_from_github(
  ...
  blend2d/blend2d
  REF
  0ca46df1d8ec7d8bc5250329ce281d82cfc96b99
  SHA512
  fbe54a59b0dc9fd0397619e3f6b1d336d3f906322a06583fe4f90bbb8bd95188f39f162b8ee66cc464050f6f40e856b72a80f37ac190a4a584fda71e2ce73689
  HEAD_REF
  master)
...
if(NOT BLEND2D_NO_JIT)
  vcpkg_from_github(
    ...
    asmjit/asmjit
    REF
    a4e1e88374142f4a842892f9c4bd0b0776fdcd0a
    SHA512
  ...
  file(RENAME ${SOURCE_PATH}/3rdparty/${ASMJIT_SOURCE_DIR_NAME}
       ${SOURCE_PATH}/3rdparty/asmjit)
endif()

vcpkg_cmake_configure(SOURCE_PATH ${SOURCE_PATH} OPTIONS
                      -DBLEND2D_STATIC=${BLEND2D_STATIC} ${FEATURE_OPTIONS})
...
# Handle copyright
configure_file(${SOURCE_PATH}/LICENSE.md
