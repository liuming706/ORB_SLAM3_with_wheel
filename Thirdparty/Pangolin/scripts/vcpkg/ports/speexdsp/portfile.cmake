if(VCPKG_USE_HEAD_VERSION)
  ...
  # Since the github repo is out-dated, use official download URL for release
  # builds to reduce traffic to the Gitlab host
  vcpkg_download_distfile(
    ARCHIVE
    URLS
    "http://downloads.xiph.org/releases/speex/speexdsp-1.2.1.tar.gz"
    FILENAME
...
vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}" OPTIONS -DUSE_SSE=${USE_SSE}
                      -DUSE_NEON=${USE_NEON})
