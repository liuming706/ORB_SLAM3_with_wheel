...
vcpkg_download_distfile(
  ...
  FILENAME
  "ncurses-${NCURSES_VERSION_STR}.tgz"
  SHA512
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
  list(APPEND OPTIONS --with-shared --with-cxx-shared --without-normal)
endif()
if(VCPKG_TARGET_IS_MINGW)
  list(APPEND OPTIONS --disable-home-terminfo --enable-term-driver
       --disable-termcap)
endif()
