...
if(buildtrees_path_length GREATER 35 AND CMAKE_HOST_WIN32)
  ...
  message(
    WARNING
      "The ${PORT} source was will be extracted to ${CURRENT_BUILDTREES_DIR} , which has more then 35 characters in length."
  )
  message(
    FATAL_ERROR "terminating due to ${CURRENT_BUILDTREES_DIR} being too long.")
endif()
# set(VCPKG_BUILD_TYPE release) #You probably want to set this to reduce build
# type and space requirements
message(
  STATUS
    "${PORT} requires a lot of free disk space (>100GB), ram (>8 GB) and time (>2h per configuration) to be successfully build.\n\
...
if(NOT VCPKG_TARGET_IS_WINDOWS)
  message(
    STATUS
      "If ${PORT} directly fails ${PORT} might require additional prerequisites on Linux and OSX. Please check the configure logs.\n"
  )
endif()
...
set(NODEJS
    "${CURRENT_HOST_INSTALLED_DIR}/tools/node/node${VCPKG_HOST_EXECUTABLE_SUFFIX}"
)
...
set(PATCHES common.pri.patch gl.patch build_1.patch build_2.patch
...
if(NOT VCPKG_TARGET_IS_WINDOWS)
  list(APPEND OPTIONS "-webengine-system-libwebp" "-webengine-system-ffmpeg"
