function(install_autopoint)
  ...
  file(STRINGS "${SOURCE_PATH}/gettext-tools/configure" VERSIONS_FROM_CONFIGURE
  ...
  file(COPY "${SOURCE_PATH}/gettext-tools/misc/archive.dir.tar"
  ...
  file(
    ...
    FILE_PERMISSIONS
      ...
      WORLD_READ
      WORLD_EXECUTE)
  file(INSTALL "${WORKING_DIR}/archive.dir.tar.gz"
       DESTINATION "${CURRENT_PACKAGES_DIR}/share/gettext/gettext")
endfunction()
