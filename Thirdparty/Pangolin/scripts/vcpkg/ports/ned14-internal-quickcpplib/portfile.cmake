# QuickCppLib is composed of other third party libraries: <= quickcpplib <=
# byte-lite <= gsl-lite <= Optional
#
# byte-lite and gsl-lite are in vcpkg, but may not be versions known to be
# compatible with QuickCppLib. It has occurred in the past that newer versions
# were severely broken with QuickCppLib.
...
vcpkg_check_features(
  ...
  INVERTED_FEATURES
  polyfill-cxx17
  QUICKCPPLIB_REQUIRE_CXX17
  polyfill-cxx20
  QUICKCPPLIB_REQUIRE_CXX20)
...
# Quickcpplib deploys subsets of the dependency headers into a private
# subdirectory
...
if(NOT QUICKCPPLIB_REQUIRE_CXX20)
  file(
    COPY "${CURRENT_INSTALLED_DIR}/include/nonstd/span.hpp"
...
file(COPY "${OPT_SOURCE_PATH}/."
     DESTINATION "${SOURCE_PATH}/include/quickcpplib/optional")

# Because quickcpplib's deployed files are header-only, the debug build it not
# necessary
...
if(QUICKCPPLIB_REQUIRE_CXX17)
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/quickcpplib/byte.hpp"
                       "#if QUICKCPPLIB_USE_STD_BYTE" "#if 1")
else()
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/quickcpplib/byte.hpp"
                       "#if QUICKCPPLIB_USE_STD_BYTE" "#if 0")
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/include/quickcpplib/byte.hpp"
    "#include \"byte/include/nonstd/byte.hpp\"" "#include <nonstd/byte.hpp>")
endif()
if(QUICKCPPLIB_REQUIRE_CXX20)
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/quickcpplib/span.hpp"
                       "#ifdef QUICKCPPLIB_USE_STD_SPAN" "#if 1")
else()
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/quickcpplib/span.hpp"
                       "#ifdef QUICKCPPLIB_USE_STD_SPAN" "#if 0")
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/include/quickcpplib/span.hpp"
...
vcpkg_cmake_config_fixup(PACKAGE_NAME quickcpplib CONFIG_PATH
                         lib/cmake/quickcpplib)
