...
# It instead verifies that Vulkan is installed. Other packages can depend on
# this package to declare a dependency on Vulkan.
...
# Check if the user left the version in the installation directory e.g.
# c:/vulkanSDK/1.1.82.1/
if(VULKAN_DIR MATCHES "(([0-9]+)\\.([0-9]+)\\.([0-9]+)\\.([0-9]+))")
  ...
  if(VULKAN_MAJOR LESS 1
     OR VULKAN_MINOR LESS 1
     OR VULKAN_PATCH LESS 82)
    message(
      FATAL_ERROR
        "Vulkan ${VULKAN_VERSION} but ${VULKAN_REQUIRED_VERSION} is required. Please download and install a more recent version from:"
        "\n    https://vulkan.lunarg.com/sdk/home\n")
  endif()
endif()

if(EXISTS ${VULKAN_DIR}/../LICENSE.txt)
  configure_file(${VULKAN_DIR}/../LICENSE.txt
                 ${CURRENT_PACKAGES_DIR}/share/vulkan/copyright COPYONLY)
elseif(EXISTS ${VULKAN_DIR}/LICENSE.txt)
  configure_file(${VULKAN_DIR}/LICENSE.txt
                 ${CURRENT_PACKAGES_DIR}/share/vulkan/copyright COPYONLY)
else()
  configure_file(${CURRENT_PORT_DIR}/LICENSE.txt
                 ${CURRENT_PACKAGES_DIR}/share/vulkan/copyright COPYONLY)
endif()
