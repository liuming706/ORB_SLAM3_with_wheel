vcpkg_from_sourceforge(
  ...
  SOURCE_PATH
  REPO
  freeimage/Source%20Distribution
  REF
  3.18.0
  FILENAME
  "FreeImage3180.zip"
...
file(COPY ${CMAKE_CURRENT_LIST_DIR}/FreeImageConfig-static.h
     DESTINATION ${SOURCE_PATH})
file(COPY ${CMAKE_CURRENT_LIST_DIR}/FreeImageConfig-dynamic.h
     DESTINATION ${SOURCE_PATH})

# This is not strictly necessary, but to make sure that no "internal" libraries
# are used we remove them
...
file(
  INSTALL ${SOURCE_PATH}/license-fi.txt
