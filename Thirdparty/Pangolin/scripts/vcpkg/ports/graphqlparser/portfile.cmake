vcpkg_from_github(
  ...
  v0.7.0
  SHA512
  973292b164d0d2cfe453a2f01559dbdb1b9d22b6304f6a3aabf71e2c0a3e24ab69dfd72a086764ad5befecf0005620f8e86f552dacc324f9615a05f31de7cede
  HEAD_REF
  master
  PATCHES
  win-cmake.patch
...
elseif(NOT VCPKG_CMAKE_SYSTEM_NAME OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL
                                      "WindowsStore")
...
vcpkg_replace_string(
  "${CURRENT_PACKAGES_DIR}/include/graphqlparser/parser.tab.hpp"
  "${SOURCE_PATH}" "")

# Handle copyright
configure_file("${SOURCE_PATH}/LICENSE"
               "${CURRENT_PACKAGES_DIR}/share/graphqlparser/copyright" COPYONLY)
