...
vcpkg_from_github(
  ...
  ${OPENCV_VERSION}
  SHA512
  de7d24ac7ed78ac14673011cbecc477cae688b74222a972e553c95a557b5cb8e5913f97db525421d6a72af30998ca300112fa0b285daed65f65832eb2cf7241a
  HEAD_REF
  master
  PATCHES
...
if("python" IN_LIST FEATURES)
  if(VCPKG_TARGET_IS_LINUX OR VCPKG_TARGET_IS_OSX)
    message(
      STATUS
        "You need to manually ensure that python2 virtualenv module is installed"
    )
    ...
    message(
      "On some system, these commands must be run as root, otherwise error about virtualenv module missing will persist!"
    )
  endif()
  x_vcpkg_get_python_packages(PYTHON_VERSION "2" PACKAGES numpy OUT_PYTHON_VAR
                              "PYTHON2")
...
vcpkg_cmake_configure(
  ...
  -DWITH_ZLIB=ON
  -WITH_GTK=${WITH_GTK}
  -DWITH_CUBLAS=OFF # newer libcublas cannot be found by the old cuda cmake
                    # script in opencv2, requires a fix
)
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  file(READ "${CURRENT_PACKAGES_DIR}/share/opencv2/OpenCVModules.cmake"
       OPENCV_MODULES)
...
find_dependency(Qt5 COMPONENTS OpenGL)")
  ...
  file(WRITE "${CURRENT_PACKAGES_DIR}/share/opencv2/OpenCVModules.cmake"
       "${OPENCV_MODULES}")
