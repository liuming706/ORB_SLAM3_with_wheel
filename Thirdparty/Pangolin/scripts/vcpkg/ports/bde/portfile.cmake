...
set(SOURCE_PATH_DEBUG
    ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/bde-${BDE_VERSION})
set(SOURCE_PATH_RELEASE
    ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/bde-${BDE_VERSION})
...
vcpkg_from_github(
  ...
  "bloomberg/bde-tools"
  REF
  d4b1a7670829228f4ec81ecdccc598ce03ae8e80
  SHA512
  80af734c080adb225d5369157301ae0af18e02b1912351e34d23f5f2ba4e19f9ae2b5a367923f036330c9f9afd11a90cdf12680eb3e59b4297a312a1b713f17f
  HEAD_REF
  master)
...
vcpkg_from_github(
  ...
  "bloomberg/bde"
  REF
  3720d132d0879f19b9084cca62ebc75f1f24e1a3
  SHA512
...
elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
  ...
  message(
    FATAL_ERROR "Unsupported target architecture: ${VCPKG_TARGET_ARCHITECTURE}")
endif()
