function(set_library_target NAMESPACE LIB_NAME DEBUG_DIR RELEASE_DIR
         INCLUDE_DIR)
  add_library(${NAMESPACE}::${LIB_NAME} STATIC IMPORTED)

  find_library(
    RELEASE_LIB_FILE_NAME
  ...
  if(LIBODBC_USE_STATIC_LIB)
    ...
    set_property(
      TARGET ${NAMESPACE}::${LIB_NAME} PROPERTY INTERFACE_LINK_LIBRARIES
                                                ${CMAKE_DL_LIBS} Iconv::Iconv)
  endif()
...
set_library_target("UNIX" "odbc" "${ROOT}/debug/lib/" "${ROOT}/lib/"
                   "${ROOT}/include/")
