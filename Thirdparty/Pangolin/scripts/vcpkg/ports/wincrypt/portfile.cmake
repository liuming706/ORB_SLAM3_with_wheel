...
if(WINDOWS_SDK MATCHES "10.")
  set(LIBFILEPATH
      "$ENV{WindowsSdkDir}Lib\\${WINDOWS_SDK}\\um\\${TRIPLET_SYSTEM_ARCH}\\Crypt32.Lib"
  )
  set(HEADERSPATH "$ENV{WindowsSdkDir}Include\\${WINDOWS_SDK}\\um")
elseif(WINDOWS_SDK MATCHES "8.")
  set(LIBFILEPATH
      "$ENV{WindowsSdkDir}Lib\\winv6.3\\um\\${TRIPLET_SYSTEM_ARCH}\\Crypt32.Lib"
  )
...
if(NOT EXISTS "${LIBFILEPATH}")
  message(
    FATAL_ERROR
      "Cannot find Windows ${WINDOWS_SDK} SDK. File does not exist: ${LIBFILEPATH}"
  )
endif()
...
if(WINDOWS_SDK MATCHES "10.")
  file(
    WRITE ${CURRENT_PACKAGES_DIR}/share/wincrypt/copyright
