...
set(LIBRTTOPO_PACKAGE_SUM
    "d9c2f4db1261cc942152d348abb7f03e6053a63b6966e081c5381d40bbebd3c7ca1963224487355f384d7562a90287fb24d7af9e7eda4a1e230ee6441cef5de9"
)

vcpkg_download_distfile(
  ARCHIVE
  URLS
  "https://download.osgeo.org/librttopo/src/librttopo-${LIBRTTOPO_VERSION_STR}.tar.gz"
  FILENAME
  "librttopo-${LIBRTTOPO_VERSION_STR}.tar.gz"
  SHA512
  ${LIBRTTOPO_PACKAGE_SUM})
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  ...
  configure_file("${CMAKE_CURRENT_LIST_DIR}/rttopo_config.h.in"
                 "${SOURCE_PATH}/src/rttopo_config.h" @ONLY)
  ...
  file(GLOB LIBRTTOPO_INCLUDE
       "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/headers/*.h")
  file(COPY ${LIBRTTOPO_INCLUDE} DESTINATION "${CURRENT_PACKAGES_DIR}/include")

  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/bin")
    file(COPY "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/librttopo.lib"
         DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  endif()
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/bin")
    file(COPY "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/librttopo.lib"
