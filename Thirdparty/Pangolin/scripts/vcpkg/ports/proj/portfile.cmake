...
vcpkg_from_github(
  ...
  "${VERSION}"
  SHA512
  bdc3cba27f330829b30290f563cb1cded75d3861909399177334a354662f4cb54e05baef40b8d267978c746f41543c3de1c119ca08919c87fd9460506c5c566e
  HEAD_REF
  master
  PATCHES
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  ...
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/include/proj.h" "#ifndef PROJ_DLL"
    "#ifndef PROJ_DLL\n#  define PROJ_DLL\n#elif 0")
endif()
...
if(NOT DEFINED VCPKG_BUILD_TYPE
  ...
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/proj.pc"
                       " -lproj" " -lproj_d")
endif()
