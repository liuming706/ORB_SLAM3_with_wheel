...
set(SHAPELIB_HASH
    230939afb33aee042808a32b38ee9dfc7ec1f39432e5a4ebe3fda99c2f87bfbebc91830d4e21691c51aae3f4bb65d7e71e7061472bb08124dcd3402c46800d6c
)

vcpkg_download_distfile(
  ARCHIVE
  URLS
  "http://download.osgeo.org/shapelib/shapelib-${SHAPELIB_VERSION}.zip"
  FILENAME
  "shapelib-${SHAPELIB_VERSION}.zip"
  SHA512
  ${SHAPELIB_HASH})

vcpkg_extract_source_archive_ex(OUT_SOURCE_PATH SOURCE_PATH ARCHIVE ${ARCHIVE}
                                PATCHES option-build-test.patch)

vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}" OPTIONS -DBUILD_TEST=OFF)
