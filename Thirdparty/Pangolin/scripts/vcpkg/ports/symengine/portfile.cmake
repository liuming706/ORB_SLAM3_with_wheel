vcpkg_from_github(
  ...
  symengine/symengine
  REF
  7b1880824c2cce98787ae29a317682ba6c294484 # v0.9.0
  SHA512
  745b2616b88032ff047a28e46b703bc1912d109524f8aa411a5b7a650a6d89d3f16dc92812381e95b13bc5cf61218d2ff3db9d3809443264340eae180968cbcf
  HEAD_REF
  master)
...
if(integer-class-boostmp IN_LIST FEATURES)
  ...
  if(integer-class-flint IN_LIST FEATURES)
    message(
      WARNING
        "Both boostmp and flint are given for integer class, will use boostmp only."
    )
  endif()
...
file(REMOVE
     "${CURRENT_PACKAGES_DIR}/include/symengine/symengine_config_cling.h")

vcpkg_replace_string(
  "${CURRENT_PACKAGES_DIR}/share/symengine/SymEngineConfig.cmake"
