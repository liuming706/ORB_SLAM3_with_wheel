...
set(${PORT}_PATCHES remove_unistd.patch remove_export_macro.patch
                    static_find_modules.patch fix_avfoundation_target.patch)

# Maybe TODO: ALSA + PulseAudio? (Missing Ports) -> check ALSA since it was
# added

# qt_find_package(ALSA PROVIDED_TARGETS ALSA::ALSA MODULE_NAME multimedia
# QMAKE_LIB alsa) qt_find_package(AVFoundation PROVIDED_TARGETS
# AVFoundation::AVFoundation MODULE_NAME multimedia QMAKE_LIB avfoundation)
# qt_find_package(WrapPulseAudio PROVIDED_TARGETS WrapPulseAudio::WrapPulseAudio
# MODULE_NAME multimedia QMAKE_LIB pulseaudio) qt_find_package(WMF
# PROVIDED_TARGETS WMF::WMF MODULE_NAME multimedia QMAKE_LIB wmf)
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  if("gstreamer" IN_LIST FEATURES AND "ffmpeg" IN_LIST FEATURES)
    message(
      FATAL_ERROR
        "Qt will by default autolink both plugin backends in static builds leading to symbol collisions and a build failure in dependent ports!\n
