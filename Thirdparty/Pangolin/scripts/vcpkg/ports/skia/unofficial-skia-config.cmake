if(NOT TARGET unofficial::skia::skia)
  ...
  set_target_properties(
    unofficial::skia::skia PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                      "${z_vcpkg_skia_root}/include/skia")

  find_library(
    z_vcpkg_skia_lib_release
    NAMES skia skia.dll
    PATHS "${z_vcpkg_skia_root}/lib"
    NO_DEFAULT_PATH)
  find_library(
    z_vcpkg_skia_lib_debug
    NAMES skia skia.dll
    PATHS "${z_vcpkg_skia_root}/debug/lib"
    NO_DEFAULT_PATH)
  ...
  z_vcpkg_skia_get_link_libraries(
    ...
    "${z_vcpkg_skia_root}/lib;${z_vcpkg_skia_root}/debug/lib" "@SKIA_DEP_REL@")
  set_target_properties(
    ...
    PROPERTIES
      ...
      "\$<\$<NOT:${z_vcpkg_skia_config_debug}>:@SKIA_DEFINITIONS_REL@>"
      INTERFACE_LINK_LIBRARIES
      "\$<LINK_ONLY:\$<\$<NOT:${z_vcpkg_skia_config_debug}>:${z_vcpkg_skia_link_libs_release}>>"
  )
  ...
  if(z_vcpkg_skia_lib_debug)
    ...
    set_property(
      ...
      PROPERTY
        INTERFACE_LINK_LIBRARIES
        "\$<LINK_ONLY:\$<\$<CONFIG:Debug>:${z_vcpkg_skia_link_libs_debug}>>")
  endif()
