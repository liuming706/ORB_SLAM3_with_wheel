vcpkg_from_gitlab(
  ...
  GNOME/pango
  REF
  3d3f165e77178b630d7dc2b733e64af513c99f5f # v1.50.12
  SHA512
  02ddcd0be05d6c8a84f186e6ea5c64019e34922480769f9b8e6e6883dd9d30b7d473681b6dbdf84c5a7e592f0d7bf37984adf2c9b40f37d6207b4bf40bdeaa7b
  HEAD_REF
  master # branch name
)
...
if(EXISTS "${_file}")
  vcpkg_replace_string(
    "${_file}" [[-I"${includedir}/pango-1.0"]]
    [[-I"${includedir}/pango-1.0" -I"${includedir}/harfbuzz"]])
endif()
