...
vcpkg_from_git(
  ...
  SOURCE_PATH
  URL
  https://git.code.sf.net/p/crashrpt/code
  REF
  4616504670be5a425a525376648d912a72ce18f2
  PATCHES
...
# Vendored minizip is still used since it contains modifications needed for
# CrashRpt
foreach(
  DEPENDENCY
  dbghelp
...
vcpkg_check_features(
  ...
  FEATURES
  probe
  CRASHRPT_BUILD_PROBE
  tests
  CRASHRPT_BUILD_TESTS
  demos
  CRASHRPT_BUILD_DEMOS)

vcpkg_cmake_configure(
  SOURCE_PATH "${SOURCE_PATH}" OPTIONS
  -DCRASHRPT_BUILD_SHARED_LIBS=${CRASHRPT_BUILD_SHARED_LIBS}
  -DCRASHRPT_LINK_CRT_AS_DLL=${CRASHRPT_LINK_CRT_AS_DLL} ${FEATURE_OPTIONS})
