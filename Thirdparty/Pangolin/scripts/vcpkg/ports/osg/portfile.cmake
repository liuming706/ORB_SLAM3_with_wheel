...
vcpkg_from_github(
  ...
  osgdb_zip_nozip.patch # This is fix symbol clashes with other libs when built
                        # in static-lib mode
  openexr3.patch
...
if(VCPKG_TARGET_IS_MINGW)
  list(APPEND OPTIONS -D_OPENTHREADS_ATOMIC_USE_WIN32_INTERLOCKED=0
       -D_OPENTHREADS_ATOMIC_USE_GCC_BUILTINS=1)
elseif(VCPKG_TARGET_IS_WINDOWS)
  list(APPEND OPTIONS -D_OPENTHREADS_ATOMIC_USE_WIN32_INTERLOCKED=1
...
elseif(VCPKG_CROSSCOMPILING)
  message(
    WARNING
      "Atomics detection may fail for cross builds. You can set osg cmake variables in a custom triplet."
  )
endif()
...
vcpkg_check_features(
  ...
  fontconfig
  OSG_TEXT_USE_FONTCONFIG
  freetype
  BUILD_OSG_PLUGIN_FREETYPE
  freetype
  CMAKE_REQUIRE_FIND_PACKAGE_Freetype
  collada
  BUILD_OSG_PLUGIN_DAE
  collada
  CMAKE_REQUIRE_FIND_PACKAGE_COLLADA
  nvtt
  BUILD_OSG_PLUGIN_NVTT
  nvtt
  CMAKE_REQUIRE_FIND_PACKAGE_NVTT
  openexr
  BUILD_OSG_PLUGIN_EXR
  openexr
  CMAKE_REQUIRE_FIND_PACKAGE_OpenEXR
  rest-http-device
  BUILD_OSG_PLUGIN_RESTHTTPDEVICE
  sdl1
  BUILD_OSG_PLUGIN_SDL
  INVERTED_FEATURES
  sdl1
  CMAKE_DISABLE_FIND_PACKAGE_SDL # for apps and examples
)

# The package osg can be configured to use different OpenGL profiles via a
# custom triplet file: Possible values are GLCORE, GL2, GL3, GLES1, GLES2,
# GLES3, and GLES2+GLES3
...
set(plugin_vars "")
file(STRINGS "${SOURCE_PATH}/src/osgPlugins/CMakeLists.txt" plugin_lines
     REGEX "ADD_PLUGIN_DIRECTORY")
foreach(line IN LISTS plugin_lines)
  if(NOT line MATCHES "ADD_PLUGIN_DIRECTORY\\(([^)]*)"
     OR NOT EXISTS
        "${SOURCE_PATH}/src/osgPlugins/${CMAKE_MATCH_1}/CMakeLists.txt")
    continue()
  endif()
...
if(NOT VCPKG_BUILD_TYPE)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/openscenegraph.pc" "\\\n" " ")
endif()
