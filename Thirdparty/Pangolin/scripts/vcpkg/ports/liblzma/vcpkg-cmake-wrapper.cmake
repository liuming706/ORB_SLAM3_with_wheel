...
if(NOT "CONFIG" IN_LIST ARGS
   AND NOT "NO_MODULE" IN_LIST ARGS
   AND NOT CMAKE_DISABLE_FIND_PACKAGE_LibLZMA)
  ...
  if(NOT TARGET LibLZMA::LibLZMA)
    ...
    if(DEFINED LIBLZMA_INCLUDE_DIRS)
      set_target_properties(
        LibLZMA::LibLZMA PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
    ...
    if(EXISTS "${LIBLZMA_LIBRARY}")
      set_target_properties(
        LibLZMA::LibLZMA PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C"
