...
#
# Adapted from
# https://github.com/pytorch/pytorch/blob/master/cmake/Modules/FindNCCL.cmake
...
if(USE_STATIC_NCCL)
  ...
  if(_NCCL_VERSION) # Prefer the versioned library if a specific NCCL version is
                    # specified
    set(CMAKE_FIND_LIBRARY_SUFFIXES ".a.${_NCCL_VERSION}"
  ...
  if(_NCCL_VERSION) # Prefer the versioned library if a specific NCCL version is
                    # specified
    set(CMAKE_FIND_LIBRARY_SUFFIXES ".so.${_NCCL_VERSION}"
                                    ${CMAKE_FIND_LIBRARY_SUFFIXES})
  endif()
endif()
...
if(NCCL_HEADER_CONTENTS)
  ...
  if(NOT _NCCL_VERSION_MAJOR)
    ...
    set(_NCCL_VERSION
        "${_NCCL_VERSION_MAJOR}.${_NCCL_VERSION_MINOR}.${_NCCL_VERSION_PATCH}")
  endif()
endif()
...
if(NCCL_FOUND) # obtaining NCCL version and some sanity checks
  message(
    STATUS
      "Found NCCL ${_NCCL_VERSION} (include: ${NCCL_INCLUDE_DIRS}, library: ${NCCL_LIBRARIES})"
  )
