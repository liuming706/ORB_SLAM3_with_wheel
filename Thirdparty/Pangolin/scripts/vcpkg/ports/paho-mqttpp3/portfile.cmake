...
vcpkg_from_github(
  ...
  REF
  33921c8b68b351828650c36816e7ecf936764379 # v1.2.0
  SHA512
  3f4a91987e0106e50e637d8d4fb13a4f8aca14eea168102664fdcebd1260609434e679f5986a1c4d71746735530f1b72fc29d2ac05cb35b3ce734a6aab1a0a55
  HEAD_REF
  master
  PATCHES
  fix-dependency.patch)

vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS FEATURES "ssl"
                     PAHO_WITH_SSL)
...
# NOTE: the Paho C++ cmake files on Github are problematic. It uses two
# different options PAHO_BUILD_STATIC and PAHO_BUILD_SHARED instead of just
# using one variable. Unless the open source community cleans up the cmake
# files, we are stuck with setting both of them.
...
vcpkg_cmake_install()
vcpkg_copy_pdbs()
vcpkg_cmake_config_fixup(PACKAGE_NAME PahoMqttCpp CONFIG_PATH
                         "lib/cmake/PahoMqttCpp")
...
# Add copyright
file(
  INSTALL "${SOURCE_PATH}/about.html"
