...
if(VCPKG_HOST_IS_LINUX
  ...
  vcpkg_from_git(
    OUT_SOURCE_PATH LSS_SOURCE_PATH URL
    https://chromium.googlesource.com/linux-syscall-support REF
...
vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}" OPTIONS -DINSTALL_HEADERS=ON)

vcpkg_cmake_install()
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/include")
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/include/client/linux/data"
     "${CURRENT_PACKAGES_DIR}/include/client/linux/sender")

vcpkg_cmake_config_fixup(PACKAGE_NAME unofficial-breakpad CONFIG_PATH
                         share/unofficial-breakpad)
