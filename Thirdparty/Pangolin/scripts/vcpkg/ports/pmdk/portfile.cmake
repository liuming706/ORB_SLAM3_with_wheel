...
vcpkg_from_github(
  ...
  pmem/pmdk
  REF
  73d8f958e855904dc0776a7d77d0f0d3698a65b1 # v1.12.0
  SHA512
  ffe77796c9028478985ca98e4162a671e3e7f580faa46b31d0dcf8c5e97aa6478044efdf7ad238285044f18f754a20a4e2a1b5992c7b9cffa709884eb62007ab
  HEAD_REF
  master)
...
vcpkg_build_msbuild(
  PROJECT_PATH
  ${SOURCE_PATH}/src/PMDK.sln
  TARGET
  "Solution Items\\libpmem,Solution Items\\libpmemlog,Solution Items\\libpmemblk,Solution Items\\libpmemobj,Solution Items\\libpmempool,Solution Items\\Tools\\pmempool"
  OPTIONS
  /p:SRCVERSION=${PMDK_VERSION})
...
file(INSTALL ${HEADER_FILES}
     DESTINATION ${CURRENT_PACKAGES_DIR}/include/libpmemobj)
...
file(INSTALL ${RELEASE_ARTIFACTS_PATH}/libs/pmempool.exe
