vcpkg_from_github(
  ...
  v2.51.1
  SHA512
  e03a0188f11634ba645f321f190758807670fcaeaa2695c1d1ddc4585e43c2b00ca42b4e820b07f5e0c1ee7c026347b3802d4a86717a3d0500c359c08494aa32
  HEAD_REF
  master
  PATCHES
  fix_openni2.patch
...
file(COPY "${SOURCE_PATH}/src/win7/drivers/IntelRealSense_D400_series_win7.inf"
...
if(VCPKG_TARGET_IS_WINDOWS)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/realsense2/realsense2Targets.cmake"
    "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel" "\${_IMPORT_PREFIX}")
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/realsense2/realsense2Targets.cmake"
    "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg" "\${_IMPORT_PREFIX}")
endif()
vcpkg_copy_pdbs()
...
if(BUILD_OPENNI2_BINDINGS)
  file(GLOB RS2DRIVER
       "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/_out/rs2driver*")
  if(RS2DRIVER)
    file(COPY ${RS2DRIVER}
