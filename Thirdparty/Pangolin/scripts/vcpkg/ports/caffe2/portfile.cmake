...
vcpkg_from_github(
  ...
  caffe2/caffe2
  REF
  eab13a2d5c807bf5d49efd4584787b639a981b79
  SHA512
  505a8540b0c28329c4e2ce443ac8e198c1ee613eb6b932927ee9d04c8afdc95081f3c4581408b7097d567840427b31f6d7626ea80f27e56532f2f2e6acd87023
  HEAD_REF
  master
  PATCHES
  msvc-fixes.patch
...
vcpkg_cmake_configure(
  ...
  -DUSE_OPENCV=OFF
  -DUSE_THREADS=ON
  # Uncomment to use MKL -DBLAS=MKL
  -DUSE_CUDA=OFF
  -DUSE_FFMPEG=OFF
  -DUSE_GLOO=OFF
  -DUSE_LEVELDB=OFF
...
# Remove empty directories from include (should probably fix or patch caffe2
# install script)
...
file(REMOVE_RECURSE
     "${CURRENT_PACKAGES_DIR}/include/caffe2/contrib/libopencl-stub")
file(REMOVE_RECURSE
