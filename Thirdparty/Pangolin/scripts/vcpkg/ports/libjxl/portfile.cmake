...
vcpkg_from_github(
  ...
  "v${VERSION}"
  SHA512
  c73039606acf7b2cbc331c6787af5167d711fd1af22bc616e1f478c531b087da82c98f2cb7e88c4d1f8bcfdc4e053ae0dc99cc9a811545b7f9658041489ed04b
  HEAD_REF
  main
  PATCHES
...
if(VCPKG_TARGET_IS_UWP)
  ...
  elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    ...
    message(
      FATAL_ERROR
        "Unsupported uwp VCPKG_TARGET_ARCHITECTURE \"${VCPKG_TARGET_ARCHITECTURE}\""
    )
  endif()
...
# libjxl always builds static libraries, so we delete them if we don't need
# them.
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
  if(VCPKG_TARGET_IS_WINDOWS)
    file(GLOB FILES_TO_REMOVE "${CURRENT_PACKAGES_DIR}/lib/*-static.lib"
         "${CURRENT_PACKAGES_DIR}/debug/lib/*-static.lib")
  else()
    file(GLOB FILES_TO_REMOVE "${CURRENT_PACKAGES_DIR}/lib/*.a"
