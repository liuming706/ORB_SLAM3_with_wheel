...
vcpkg_from_github(
  ...
  v0.18.0
  SHA512
  08a64a4b132df1519292378cef93deb3c60d21636b2a71bce6c13e29cfd93cab465cad77e11f000fb984c5c75a4ca1c92504654fd2e5201343df767ea0e610d1
  HEAD_REF
  master
  PATCHES
...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  vcpkg_execute_required_process(
    ...
    "${PWSH_PATH}"
    -Command
    "((Get-Content -AsByteStream \"${SOURCE_PATH}/stdlib/std.jsonnet\") -join ',') + ',0' | Out-File -Encoding Ascii \"${SOURCE_PATH}/core/std.jsonnet.h\""
    WORKING_DIRECTORY
    "${SOURCE_PATH}"
    LOGNAME
    "std.jsonnet")
  ...
  vcpkg_execute_required_process(
    ...
    bash
    -c
    "((od -v -Anone -t u1 \"${SOURCE_PATH}/stdlib/std.jsonnet\" | tr ' ' '\\n' | grep -v '^$' | tr '\\n' ',' ) && echo '0') > \"${SOURCE_PATH}/core/std.jsonnet.h\""
    WORKING_DIRECTORY
    "${SOURCE_PATH}"
    LOGNAME
    "std.jsonnet")
