...
vcpkg_download_distfile(
  ARCHIVE
  URLS
  "https://releases.mozilla.org/pub/nspr/releases/v${NSPR_VERSION}/src/nspr-${NSPR_VERSION}.tar.gz"
  FILENAME
  "nspr-${NSPR_VERSION}.tar.gz"
  SHA512
...
set(OPTIONS_DEBUG "--enable-debug-rtl")

set(OPTIONS_RELEASE "--disable-debug-rtl")
...
if(NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
  file(GLOB BIN_RELEASE "${CURRENT_PACKAGES_DIR}/lib/*.dll"
  ...
  if(BIN_RELEASE_SIZE GREATER 0)
    ...
    foreach(path ${BIN_RELEASE})
      ...
      file(RENAME "${CURRENT_PACKAGES_DIR}/lib/${name}"
           "${CURRENT_PACKAGES_DIR}/bin/${name}")
    endforeach()
  endif()
endif()
...
if(NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
  ...
  file(GLOB BIN_DEBUG "${CURRENT_PACKAGES_DIR}/debug/lib/*.dll"
  ...
  if(BIN_DEBUG_SIZE GREATER 0)
    ...
    foreach(path IN LISTS BIN_DEBUG)
      get_filename_component(name "${path}" NAME)
      file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/${name}"
           "${CURRENT_PACKAGES_DIR}/debug/bin/${name}")
    endforeach()
  endif()
endif()

vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/nspr-config"
                     "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../../..")

if(NOT VCPKG_BUILD_TYPE)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/tools/${PORT}/debug/bin/nspr-config"
    "${CURRENT_INSTALLED_DIR}/debug" "`dirname $0`/../../../..")
endif()

# Copy license
file(
  INSTALL "${SOURCE_PATH}/nspr/LICENSE"
