# Outcome is composed of other third party libraries: Outcome <= status-code <=
# quickcpplib <= byte-lite <= gsl-lite <= Optional
#
# byte-lite and gsl-lite are in vcpkg, but may not be versions known to be
# compatible with Outcome. It has occurred in the past that newer versions were
# severely broken with Outcome.
#
# One can fetch an 'all sources' tarball from
# https://github.com/ned14/outcome/releases which contains the exact copy of
# those third party libraries known to have passed Outcome's CI process.
...
vcpkg_from_github(
  ...
  ned14/outcome
  REF
  90032f99503b4620f21d8160dc3af06fa343541f
  SHA512
  7eda0694098a118633c8ad0ef812f8b03db536548f51d1ca71ca98b9f9e445bcb24019cd4d1046da9215227ad85205c5b3631d0c66de6edc1fcc904b2d9e0e0f
  HEAD_REF
  develop
  PATCHES
...
# Because outcome's deployed files are header-only, the debug build is not
# necessary
...
vcpkg_cmake_configure(
  ...
  -DOUTCOME_ENABLE_DEPENDENCY_SMOKE_TEST=ON # Leave this always on to test
                                            # everything compiles
