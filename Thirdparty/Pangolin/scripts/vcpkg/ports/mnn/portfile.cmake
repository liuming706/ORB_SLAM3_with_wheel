...
vcpkg_from_github(
  ...
  1.1.0
  SHA512
  3e31eec9a876be571cb2d29e0a2bcdb8209a43a43a5eeae19b295fadfb1252dd5bd4ed5b7c584706171e1b531710248193bc04520a796963e2b21546acbedae0
  HEAD_REF
  master
  PATCHES
...
# 'cuda' feature in Windows failes with Ninja because of parallel PDB access.
# Make it optional
...
set(FLATC_EXEC
    ${CURRENT_HOST_INSTALLED_DIR}/tools/flatbuffers/flatc${VCPKG_HOST_EXECUTABLE_SUFFIX}
)
...
vcpkg_execute_build_process(
  ...
  WORKING_DIRECTORY
  "${SOURCE_PATH}/schema/current/"
  LOGNAME
  flatc-${TARGET_TRIPLET})
...
vcpkg_configure_cmake(
  ...
  -DMNN_VERSION_PATCH=0
  -DMNN_VERSION_BUILD=0
  -DMNN_VERSION_SUFFIX=-d6795ad
  OPTIONS_DEBUG
...
if("test" IN_LIST FEATURES)
  ...
  # vcpkg_copy_tools( TOOL_NAMES run_test.out benchmark.out
  # benchmarkExprModels.out # test/ AUTO_CLEAN )
endif()
if("tools" IN_LIST FEATURES)
  vcpkg_copy_tools(
    ...
    timeProfile.out # tools/cpp
    quantized.out # tools/quantization
    classficationTopkEval.out # tools/evaluation
    MNNDump2Json
    MNNConvert # tools/converter
    transformer.out
    train.out
    dataTransformer.out
    runTrainDemo.out # tools/train
    AUTO_CLEAN)
  if(BUILD_SHARED)
