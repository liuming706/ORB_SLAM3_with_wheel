...
vcpkg_from_github(
  ...
  aws/aws-sdk-cpp
  REF
  a72b841c91bd421fbb6deb516400b51c06bc596c # 1.9.220
  SHA512
  9b7fa80ee155fa3c15e3e86c30b75c6019dc1672df711c4f656133fe005f104e4a30f5a99f1c0a0c6dab42007b5695169cd312bd0938b272c4c7b05765ce3421
  PATCHES
...
vcpkg_cmake_configure(
  ...
  "-DCMAKE_MODULE_PATH=${CURRENT_INSTALLED_DIR}/share/aws-c-common" # use extra
                                                                    # cmake
                                                                    # files
)
vcpkg_cmake_install()
...
foreach(TARGET IN LISTS BUILD_ONLY)
  vcpkg_cmake_config_fixup(
    PACKAGE_NAME "aws-cpp-sdk-${TARGET}" CONFIG_PATH
...
foreach(AWS_TARGET IN LISTS AWS_TARGETS)
  ...
  string(REGEX REPLACE "bin\\/([A-Za-z0-9_.-]+\\.lib)" "lib/\\1" _contents
                       "${_contents}")
