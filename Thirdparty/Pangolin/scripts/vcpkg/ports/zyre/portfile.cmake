vcpkg_from_github(
  ...
  zeromq/zyre
  REF
  2648b7eb806a2494d6eb4177f0941232d83c5294
  SHA512
  8940e82ccdc427734711d63dc01c81fe86c4ca6b7e97a69df979f4d48a4711df1ccaee6a3b6aa394f9ef91d719cb95851c4eb87dfa9ed6426e2577b95e0fb464
  HEAD_REF
  master)

configure_file(${CMAKE_CURRENT_LIST_DIR}/Config.cmake.in
               ${SOURCE_PATH}/builds/cmake/Config.cmake.in COPYONLY)

foreach(_cmake_module Findczmq.cmake Findlibzmq.cmake)
  configure_file(${CMAKE_CURRENT_LIST_DIR}/${_cmake_module}
                 ${SOURCE_PATH}/${_cmake_module} COPYONLY)
endforeach()
...
if(ZYRE_BUILD_STATIC)
  vcpkg_replace_string(${CURRENT_PACKAGES_DIR}/include/zyre_library.h
                       "if defined ZYRE_STATIC" "if 1 //if defined ZYRE_STATIC")
endif()
