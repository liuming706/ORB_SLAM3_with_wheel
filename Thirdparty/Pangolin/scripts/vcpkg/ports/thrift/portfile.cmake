# We currently insist on static only because: - Thrift doesn't yet support
# building as a DLL on Windows, - x64-linux only builds static anyway. From
...
vcpkg_from_github(
  ...
  apache/thrift
  REF
  2a93df80f27739ccabb5b885cb12a8dc7595ecdf # 0.16.0
  SHA512
  aed4f60b8a4eca5b4bce26f6f29d1178684d2b4e6de290ab1e696ac78a9f85d941afe5dca99d1d22d640371ad538b930cf445f9f899a2e322f39b0cceec307a3
  HEAD_REF
  master
  PATCHES
  "correct-paths.patch"
...
# note we specify values for WITH_STATIC_LIB and WITH_SHARED_LIB because even
# though they're marked as deprecated, Thrift incorrectly hard-codes a value for
# BUILD_SHARED_LIBS.
...
file(GLOB COMPILER "${CURRENT_PACKAGES_DIR}/bin/thrift"
     "${CURRENT_PACKAGES_DIR}/bin/thrift.exe")
if(COMPILER)
