...
# Qt Tools:
# Qt Assistant ........................... yes QDoc
# ................................... no Clang-based lupdate parser
# ............. no Qt Designer ............................ yes Qt Distance
# Field Generator ............ yes kmap2qmap .............................. yes
# Qt Linguist ............................ yes Mac Deployment Tool
# .................... no pixeltool .............................. yes qdbus
# .................................. yes qev
# .................................... yes Qt Attributions Scanner
# ................ yes qtdiag ................................. yes qtpaths
# ................................ yes qtplugininfo ...........................
# yes Windows deployment tool ................ yes
...
vcpkg_check_features(
  ...
  "qml"
  CMAKE_REQUIRE_FIND_PACKAGE_Qt6Qml
  "qml"
  CMAKE_REQUIRE_FIND_PACKAGE_Qt6Quick
  "qml"
  CMAKE_REQUIRE_FIND_PACKAGE_Qt6QuickWidgets
  "qml"
  FEATURE_distancefieldgenerator
  INVERTED_FEATURES
  "qdoc"
  ...
  "qml"
  CMAKE_DISABLE_FIND_PACKAGE_Qt6Qml
  "qml"
  CMAKE_DISABLE_FIND_PACKAGE_Qt6Quick
  "qml"
  CMAKE_DISABLE_FIND_PACKAGE_Qt6QuickWidgets)
...
if(VCPKG_TARGET_IS_OSX)
  ...
  foreach(_appfolder IN LISTS OSX_APP_FOLDERS)
    ...
    file(MAKE_DIRECTORY
         "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/${_appfolder}")
    file(RENAME "${CURRENT_PACKAGES_DIR}/bin/${_appfolder}/"
         "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/${_appfolder}/")
  endforeach()
