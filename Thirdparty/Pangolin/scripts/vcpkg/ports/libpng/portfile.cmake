...
if("apng" IN_LIST FEATURES)
  ...
  vcpkg_download_distfile(
    LIBPNG_APNG_PATCH_ARCHIVE
    URLS
    "https://downloads.sourceforge.net/project/libpng-apng/libpng16/${VERSION}/${LIBPNG_APNG_PATCH_NAME}.gz"
    FILENAME
    "${LIBPNG_APNG_PATCH_NAME}.gz"
    SHA512
    97a182da0b3b54aecf735e3655d8e8f1a569ae957b23fc3d7a9c8cc65dcdd26f34f173ce9f60af99b01d5347267b2afefaf787c500ce1005e86bf2810b3d0738
  )
  set(LIBPNG_APNG_PATCH_PATH
      "${CURRENT_BUILDTREES_DIR}/src/${LIBPNG_APNG_PATCH_NAME}")
...
vcpkg_from_github(
  ...
  v${VERSION}
  SHA512
  d61408cee5850582baa57166547ccab6cc171bc809076e53494ace26157fd7787c3209e3b757fd68c541bfb95afe309745d887fb5cd2005b2024af7355c809a0
  HEAD_REF
  master
  PATCHES
...
if(VCPKG_TARGET_IS_IOS)
  vcpkg_list(APPEND LIBPNG_HARDWARE_OPTIMIZATIONS_OPTION
...
file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/vcpkg-cmake-wrapper.cmake"
     DESTINATION "${CURRENT_PACKAGES_DIR}/share/png")

vcpkg_fixup_pkgconfig()
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  if(NOT VCPKG_BUILD_TYPE)
    vcpkg_replace_string(
      "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libpng16.pc" "-lpng16"
      "-llibpng16d")
    file(
  ...
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libpng16.pc"
                       "-lpng16" "-llibpng16")
elseif(NOT VCPKG_BUILD_TYPE)
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libpng16.pc"
                       "-lpng16" "-lpng16d")
  file(
    INSTALL "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libpng16.pc"
    DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig"
