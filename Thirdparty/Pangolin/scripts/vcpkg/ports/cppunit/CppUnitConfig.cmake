...
if(WIN32)
  find_file(
    CppUnit_LIBRARY_RELEASE_DLL
    NAMES cppunit.dll
    PATHS "${CMAKE_CURRENT_LIST_DIR}/../../bin"
    NO_DEFAULT_PATH)
  find_file(
    CppUnit_LIBRARY_DEBUG_DLL
    NAMES cppunitd.dll
    PATHS "${CMAKE_CURRENT_LIST_DIR}/../../debug/bin"
    NO_DEFAULT_PATH)
endif()
...
if((NOT EXISTS "${CppUnit_LIBRARY_RELEASE_DLL}")
   AND (EXISTS "${CppUnit_LIBRARY_RELEASE}"))
...
if((NOT EXISTS "${CppUnit_LIBRARY_DEBUG_DLL}") AND (EXISTS
                                                    "${CppUnit_LIBRARY_DEBUG}"))
