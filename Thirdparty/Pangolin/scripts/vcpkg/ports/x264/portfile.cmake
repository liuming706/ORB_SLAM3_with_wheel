vcpkg_from_github(
  ...
  mirror/x264
  REF
  baee400fa9ced6f5481a728138fed6e867b0ff7f # 0.164.3095 in pc file, to be
                                           # updated below
  SHA512
  3c7147457cbe0fea20cf3ed8cf7bbdca9ac15060cf86f81b9b5b54b018f922964e91b3c38962c81fedef92bc5b14489e04d0966d03d2b7a85b4dabab6ad816a2
  HEAD_REF
  stable
  PATCHES
  uwp-cflags.patch
...
vcpkg_replace_string("${SOURCE_PATH}/configure" [[/bin/bash]]
                     [[/usr/bin/env bash]])

# Note on x264 versioning: The pc file exports "0.164.<N>" where is the number
# of commits. This must be fixed here because vcpkg uses a GH tarball instead of
# cloning the source. (The binary releases on
# https://artifacts.videolan.org/x264/ are named x264-r<N>-<COMMIT>.)
...
# Ensure that parent-scope variable 'var' doesn't contain a space, updating
# 'ENV{PATH}' and 'var' if needed.
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/x264.pc" "-lx264"
                       "-llibx264")
  if(NOT VCPKG_BUILD_TYPE)
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/x264.pc"
                         "-lx264" "-llibx264")
  endif()
endif()
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic"
  ...
  file(RENAME "${CURRENT_PACKAGES_DIR}/lib/libx264.dll.lib"
       "${CURRENT_PACKAGES_DIR}/lib/libx264.lib")
  if(NOT VCPKG_BUILD_TYPE)
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/libx264.dll.lib"
         "${CURRENT_PACKAGES_DIR}/debug/lib/libx264.lib")
  endif()
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/x264.h"
                       "#ifdef X264_API_IMPORTS" "#if 1")
