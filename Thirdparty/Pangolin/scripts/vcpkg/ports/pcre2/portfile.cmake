vcpkg_from_github(
  ...
  pcre2-10.40
  SHA512
  098c21d60ecb3bb8449173f50c9ab8e6018fafd5d55548be08b15df37f8e08bcd4f851d75758c4d22505db30a3444bb65783d83cd876c63fdf0de2850815ef93
  HEAD_REF
  master
  PATCHES
...
set(JIT ON)
if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Emscripten" OR VCPKG_CMAKE_SYSTEM_NAME
                                                    STREQUAL "iOS")
  set(JIT OFF)
endif()
...
elseif(VCPKG_TARGET_IS_WINDOWS)
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/bin/pcre2-config"
                       "${CURRENT_PACKAGES_DIR}" "`dirname $0`/..")
  if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/bin/pcre2-config")
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/bin/pcre2-config"
                         "${CURRENT_PACKAGES_DIR}" "`dirname $0`/../..")
  endif()
endif()
