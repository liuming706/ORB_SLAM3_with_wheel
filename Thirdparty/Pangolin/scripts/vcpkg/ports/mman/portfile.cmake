vcpkg_from_github(
  ...
  witwall/mman-win32
  REF
  f5ff813c53935c3078f48e1f03a6944c4e7b459c
  SHA512
...
file(RENAME ${CURRENT_PACKAGES_DIR}/include/sys
     ${CURRENT_PACKAGES_DIR}/include/mman/sys)

file(COPY ${CMAKE_CURRENT_LIST_DIR}/usage
     DESTINATION ${CURRENT_PACKAGES_DIR}/share/mman)
file(
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/mman/sys/mman.h"
