...
get_filename_component(_vcpkg_wx_root "${CMAKE_CURRENT_LIST_DIR}/../.."
                       ABSOLUTE)
...
if(WIN32)
  ...
  function(z_vcpkg_wxwidgets_find_base_library BASENAME)
    find_library(
      WX_${BASENAME}d wx${BASENAME}32ud
      NAMES wx${BASENAME}d
      PATHS "${wxWidgets_ROOT_DIR}/debug/lib"
      NO_DEFAULT_PATH)
    find_library(
      WX_${BASENAME} wx${BASENAME}32u
      NAMES wx${BASENAME}
  ...
  function(z_vcpkg_wxwidgets_find_suffix_library BASENAME)
    foreach(lib IN LISTS ARGN)
      find_library(
        WX_${lib}d
        NAMES wx${BASENAME}32ud_${lib}
        PATHS "${wxWidgets_ROOT_DIR}/debug/lib"
        NO_DEFAULT_PATH)
      find_library(
        WX_${lib}
        NAMES wx${BASENAME}32u_${lib}
        PATHS "${wxWidgets_ROOT_DIR}/lib"
        NO_DEFAULT_PATH)
    endforeach()
  endfunction()
  ...
  z_vcpkg_wxwidgets_find_suffix_library(
    msw
    core
    adv
    aui
  ...
  # Force FindwxWidgets.cmake win32 mode for all windows targets built on
  # windows
  ...
  if(CMAKE_BUILD_TYPE STREQUAL "Debug"
     OR "Debug" IN_LIST MAP_IMPORTED_CONFIG_${CMAKE_BUILD_TYPE})
    # Debug
    set(wxWidgets_LIB_DIR
        "${wxWidgets_ROOT_DIR}/debug/lib"
        CACHE INTERNAL "")
    file(
      GLOB _vcpkg_wxconfig
      LIST_DIRECTORIES false
      "${wxWidgets_LIB_DIR}/wx/config/*")
  endif()
...
if(WIN32
   ...
   AND NOT "wx::core" IN_LIST wxWidgets_LIBRARIES)
