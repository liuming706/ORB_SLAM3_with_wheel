# test application for this port:
...
vcpkg_from_github(
  ...
  mapnik/mapnik
  REF
  d7b83c0f7d11397aff5b5d8e0bb294ef6ea4354d
  SHA512
  62b47cb753e9698e55fe88593009016676b6c0c0a90c3f29be6f44a45f9f783ec5beca6916e549f9adbdc750e2e0334a9e927fc0dcb6a88431e40c2e920ff962
  HEAD_REF
  master)
...
vcpkg_check_features(
  ...
  "input-gdal"
  USE_PLUGIN_INPUT_GDAL
  "input-geobuf"
  USE_PLUGIN_INPUT_GEOBUF
  "input-geojson"
  USE_PLUGIN_INPUT_GEOJSON
  "input-ogr"
  USE_PLUGIN_INPUT_OGR
  "input-pgraster"
  USE_PLUGIN_INPUT_PGRASTER
  "input-postgis"
  USE_PLUGIN_INPUT_POSTGIS
  "input-raster"
  USE_PLUGIN_INPUT_RASTER
  "input-shape"
  USE_PLUGIN_INPUT_SHAPE
  "input-sqlite"
  USE_PLUGIN_INPUT_SQLITE
  "input-topojson"
  USE_PLUGIN_INPUT_TOPOJSON
  "viewer"
  BUILD_DEMO_VIEWER
  "utility-geometry-to-wkb"
  BUILD_UTILITY_GEOMETRY_TO_WKB
  "utility-mapnik-index"
  BUILD_UTILITY_MAPNIK_INDEX
  "utility-mapnik-render"
  BUILD_UTILITY_MAPNIK_RENDER
  "utility-ogrindex"
  BUILD_UTILITY_OGRINDEX
  "utility-pgsql2sqlite"
  BUILD_UTILITY_PGSQL2SQLITE
  "utility-shapeindex"
  BUILD_UTILITY_SHAPEINDEX
  "utility-svg2png"
  BUILD_UTILITY_SVG2PNG)
...
if(IS_DIRECTORY "${CURRENT_PACKAGES_DIR}/bin/plugins")
  file(COPY "${CURRENT_PACKAGES_DIR}/bin/plugins"
...
if("viewer" IN_LIST FEATURES)
  ...
  file(COPY "${CURRENT_PACKAGES_DIR}/bin/viewer.ini"
       DESTINATION "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
...
if("utility-ogrindex" IN_LIST FEATURES)
  # build is currently not supported vcpkg_copy_tools(TOOL_NAMES ogrindex
  # AUTO_CLEAN)
endif()
...
file(
  WRITE "${CURRENT_PACKAGES_DIR}/share/mapnik/mapnikPlugins-debug.cmake"
...
file(
  ...
  RENAME copyright)
file(
  INSTALL "${SOURCE_PATH}/fonts/unifont_license.txt"
  DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}"
  RENAME fonts_copyright)
