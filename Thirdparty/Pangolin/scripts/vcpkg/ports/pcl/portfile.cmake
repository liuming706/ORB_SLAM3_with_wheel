vcpkg_from_github(
  ...
  REF
  f36a69a5e89953708990c4669317f989d532cf08 # pcl-1.12.0
  SHA512
  dbbd0adbb08949ddef2789e0021b6ca9727be33c7193d0bb135c61def09a42ed6a71333f06b6fad407010ecb4b73c19f087f7520386b92a008e90c254eafe422
  HEAD_REF
  master
  PATCHES
...
vcpkg_check_features(
  ...
  apps
  BUILD_apps
  # These 2 apps need openni1 apps            BUILD_apps_in_hand_scanner apps
  ...
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    ...
    foreach(PCL_PKGCONFIG IN LISTS PCL_PKGCONFIG_DBGS)
      ...
      if(PCL_PC_DBG MATCHES "libopenni2")
        ...
        string(REPLACE "Libs: " "Libs: -lKinect10 -lOpenNI2 " PCL_PC_DBG
                       "${PCL_PC_DBG}")
  ...
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    ...
    foreach(PCL_PKGCONFIG IN LISTS PCL_PKGCONFIG_RELS)
      ...
      if(PCL_PC_REL MATCHES "libopenni2")
        ...
        string(REPLACE "Libs: " "Libs: -lKinect10 -lOpenNI2 " PCL_PC_REL
                       "${PCL_PC_REL}")
