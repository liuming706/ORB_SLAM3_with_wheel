vcpkg_from_github(
  ...
  pocoproject/poco
  REF
  1211613642269b7d53bea58b02de7fcd25ece3b9 # poco-1.12.4-release
  SHA512
  bf390f7c8d7c4f0d7602afa434a933b429274944d12560159761b0f984316c76abfdb49ad422c869e02d88041058a04d66e7b5ae05142819a4f583870cc00f44
  HEAD_REF
  master
  PATCHES
...
# vcpkg's PCRE2 does not provide a FindPCRE2, and the bundled one seems to work
# fine file(REMOVE "${SOURCE_PATH}/cmake/FindPCRE2.cmake")
...
if("netssl" IN_LIST FEATURES)
  if(VCPKG_TARGET_IS_WINDOWS)
    list(APPEND FEATURE_OPTIONS -DENABLE_NETSSL_WIN=ON -DENABLE_NETSSL=OFF
         -DENABLE_CRYPTO=OFF)
  else()
    list(APPEND FEATURE_OPTIONS -DENABLE_NETSSL=ON -DENABLE_CRYPTO=ON)
  endif()
endif()
...
vcpkg_cmake_configure(
  ...
  -DPOCO_MT=${POCO_MT}
  -DENABLE_TESTS=OFF
  # Allow enabling and disabling components POCO_ENABLE_SQL_ODBC,
  # POCO_ENABLE_SQL_MYSQL and POCO_ENABLE_SQL_POSTGRESQL are defined on the fly
  # if the required librairies are present
