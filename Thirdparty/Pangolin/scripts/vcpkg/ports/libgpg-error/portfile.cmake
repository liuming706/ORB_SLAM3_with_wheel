...
vcpkg_extract_source_archive(SOURCE_PATH ARCHIVE "${tarball}" PATCHES
                             cross-tools.patch pkgconfig-libintl.patch)
...
vcpkg_replace_string(
  "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/gpg-error-config"
  "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../../..")
if(NOT VCPKG_BUILD_TYPE)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/tools/${PORT}/debug/bin/gpg-error-config"
    "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../../../..")
endif()
