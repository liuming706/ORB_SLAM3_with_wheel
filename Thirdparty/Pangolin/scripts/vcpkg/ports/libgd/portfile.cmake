vcpkg_from_github(
  ...
  libgd/libgd
  REF
  b5319a41286107b53daa0e08e402aa1819764bdc # gd-2.3.3
  SHA512
  b4c6ca1d9575048de35a38b0db69e7380e160293133c1f72ae570f83ce614d4f2fd2615d217f7a0023e2265652c1089561b906beabca56c15e6ec0250e4394b2
  HEAD_REF
  master
  PATCHES
  control-build.patch
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  ...
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/gdlib.pc" " -lgd"
                       " -llibgd${suffix}")
  if(NOT VCPKG_BUILD_TYPE)
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/gdlib.pc"
                         " -lgd" " -llibgd${suffix}")
  endif()
endif()
...
if(ENABLE_TOOLS)
  ...
  file(RENAME "${CURRENT_PACKAGES_DIR}/bin/bdftogd"
       "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bdftogd")
