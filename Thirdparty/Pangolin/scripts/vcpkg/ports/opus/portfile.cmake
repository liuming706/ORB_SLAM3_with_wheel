...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS FEATURES avx
                     AVX_SUPPORTED)
...
if(VCPKG_TARGET_IS_MINGW)
  ...
  if(VCPKG_TARGET_ARCHITECTURE MATCHES "^(ARM|arm)64$")
    list(APPEND ADDITIONAL_OPUS_OPTIONS "-DOPUS_USE_NEON=OFF") # for version
                                                               # 1.3.1 (remove
                                                               # for future Opus
                                                               # release)
    list(APPEND ADDITIONAL_OPUS_OPTIONS "-DOPUS_DISABLE_INTRINSICS=ON"
    )# for HEAD (and future Opus release)
  endif()
