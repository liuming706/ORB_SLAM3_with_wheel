...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS FEATURES curl UseCurl)
...
vcpkg_fixup_cmake_targets(CONFIG_PATH share/unofficial-cfitsio TARGET_PATH
                          share/unofficial-cfitsio)

file(
  READ
  ${CURRENT_PACKAGES_DIR}/share/unofficial-cfitsio/unofficial-cfitsio-config.cmake
  ASSIMP_CONFIG)
file(
  WRITE
  ${CURRENT_PACKAGES_DIR}/share/unofficial-cfitsio/unofficial-cfitsio-config.cmake
...
file(INSTALL ${SOURCE_PATH}/FindPthreads.cmake
     DESTINATION ${CURRENT_PACKAGES_DIR}/share/unofficial-cfitsio)
