...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  # $LIBS is an environment variable that vcpkg already pre-populated with some
  # libraries. We need to re-purpose it when passing LIBS option to make to
  # avoid overriding the vcpkg's own list.
...
vcpkg_install_copyright(
  FILE_LIST "${SOURCE_PATH}/COPYING" "${SOURCE_PATH}/doc/COPYING.LESSER"
