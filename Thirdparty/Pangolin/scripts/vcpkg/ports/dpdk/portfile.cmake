...
string(REPLACE "-Denable_docs=true" "-Denable_docs=false" DPDK_OPTIONS_DEBUG
               "${DPDK_OPTIONS}")
...
if("docs" IN_LIST FEATURES)
  ...
  file(RENAME "${CURRENT_PACKAGES_DIR}/share/doc/dpdk"
       "${CURRENT_PACKAGES_DIR}/share/dpdk/doc")
endif()
