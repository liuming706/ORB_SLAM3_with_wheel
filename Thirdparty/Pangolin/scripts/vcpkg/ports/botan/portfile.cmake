...
vcpkg_from_github(
  ...
  "${VERSION}"
  SHA512
  0f99ef4026e5180dd65dc0e935ba2cabaf750862c651699294b3521053463b7e65a90847fef6f0d640eb9f9eb5efce64b13e999aa9c215310998817d13bd5332
  HEAD_REF
  master
  PATCHES
...
if("zlib" IN_LIST FEATURES)
  ...
  x_vcpkg_pkgconfig_get_modules(LIBS PREFIX "ZLIB" MODULES "zlib"
                                ${pkgconfig_syntax})
endif()
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
  ...
  if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    vcpkg_list(APPEND configure_arguments --enable-shared-library
               --disable-static-library)
  else()
    vcpkg_list(APPEND configure_arguments --disable-shared-library
  ...
  # botan's install.py doesn't handle DESTDIR on windows host, so we must avoid
  # the standard '--prefix' and 'DESTDIR' install.
  vcpkg_configure_make(
    ...
    "--with-external-libdir=${CURRENT_INSTALLED_DIR}/debug/lib")
  vcpkg_build_make(
    BUILD_TARGET install OPTIONS "ZLIB_LIBS_RELEASE=${ZLIB_LIBS_RELEASE}"
    "ZLIB_LIBS_DEBUG=${ZLIB_LIBS_DEBUG}")
  vcpkg_copy_tools(TOOL_NAMES botan AUTO_CLEAN)
endif()

file(RENAME "${CURRENT_PACKAGES_DIR}/include/botan-2/botan"
     "${CURRENT_PACKAGES_DIR}/include/botan")

if(pkgconfig_requires)
  list(JOIN pkgconfig_requires ", " pkgconfig_requires)
  file(APPEND "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/botan-2.pc"
       "Requires.private: ${pkgconfig_requires}")
  if(NOT VCPKG_BUILD_TYPE)
    file(APPEND "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/botan-2.pc"
         "Requires.private: ${pkgconfig_requires}")
  endif()
endif()
...
vcpkg_replace_string(
  "${CURRENT_PACKAGES_DIR}/include/botan/build.h"
  "#define BOTAN_INSTALL_PREFIX R\"(${CURRENT_PACKAGES_DIR})\"" "")
vcpkg_replace_string(
  "${CURRENT_PACKAGES_DIR}/include/botan/build.h"
  "#define BOTAN_INSTALL_LIB_DIR R\"(${CURRENT_PACKAGES_DIR}\\lib)\"" "")
vcpkg_replace_string(
  "${CURRENT_PACKAGES_DIR}/include/botan/build.h"
  "#define BOTAN_INSTALL_LIB_DIR R\"(${CURRENT_PACKAGES_DIR}/lib)\"" "")
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/botan/build.h"
                     "--prefix=${CURRENT_PACKAGES_DIR}" "")
