...
vcpkg_from_github(
  ...
  REF
  b9acaab7b20fd4f984225657ffe272799ebdfefb # commit on 2021-08-04
  SHA512
  d136e68e54f39779a48b1c5bc61f81dc06b312120dc8d3788a9c360f89aa924ca4cc074c6515743a930982637f9fca94299000a4b2dca1f9c243d8d9d1c62de2
  HEAD_REF
  master)
...
foreach(THRIFT_SOURCE_FILE IN LISTS THRIFT_SOURCE_FILES)
  vcpkg_execute_required_process(
    COMMAND
    "${CURRENT_INSTALLED_DIR}/tools/thrift/thrift"
    --gen
    cpp:no_skeleton
    -o
    "${SOURCE_PATH}/data"
...
vcpkg_from_github(
  ...
  REF
  277fdd75e413c914bff04d510afafc7f0811a31a # v0.7.0
  SHA512
  5112bda5ec24621044bbcd5393922564de70f4d696b1d4248e889dd3d49e492155bfc88626fea214ce4e4cb50e9a49ea031ddb8efbaafc6f1753a586db534a50
  HEAD_REF
  master
  PATCHES
...
file(
  GLOB IDL_SOURCE_FILES
  LIST_DIRECTORIES false
  "${IDL_SOURCE_DIR}/*")
file(COPY ${IDL_SOURCE_FILES}
     DESTINATION "${SOURCE_PATH}/src/jaegertracing/thrift-gen")
