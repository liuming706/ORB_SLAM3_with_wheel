vcpkg_from_github(
  ...
  REF
  c81e1d9a0f69cc5b93588dbe330b2af587162c5f
  SHA512
...
if(VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_UWP)
  vcpkg_check_features(
    ...
    FEATURE_OPTIONS
    cairo
    OSMDCOUT_BUILD_MAP_CAIRO
    directx
    OSMDCOUT_BUILD_MAP_DIRECTX
    gdi
    OSMDCOUT_BUILD_MAP_GDI
    svg
    OSMDCOUT_BUILD_MAP_SVG)
else()
  vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS cairo
                       OSMDCOUT_BUILD_MAP_CAIRO svg OSMDCOUT_BUILD_MAP_SVG)
  list(APPEND FEATURE_OPTIONS -DOSMDCOUT_BUILD_MAP_DIRECTX=OFF
       -DOSMDCOUT_BUILD_MAP_GDI=OFF)
endif()
