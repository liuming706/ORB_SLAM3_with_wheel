vcpkg_from_github(
  ...
  ermig1979/Simd
  REF
  e61df320747449322767e67534bd7bb6a9a6d2c8 # v5.1.119
  SHA512
  9dfce424af8600aaa2c0eac8bbb8f20b12cbd086d495c7e9e1ce2a45ae60242ee893608fc41c88ff6caa960821188e4cffd586b416ab891ee86d6e28aad54726
  HEAD_REF
  master
  PATCHES
...
if(VCPKG_TARGET_IS_WINDOWS AND (VCPKG_TARGET_ARCHITECTURE STREQUAL "x86"
                                OR VCPKG_TARGET_ARCHITECTURE STREQUAL "x64"))
  ...
  if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    vcpkg_replace_string("${SOURCE_PATH}/src/Simd/SimdConfig.h"
                         "//#define SIMD_STATIC" "#define SIMD_STATIC")
    vcpkg_replace_string(
      "${SOURCE_PATH}/prj/${SOLUTION_TYPE}/Simd.vcxproj"
      "<ConfigurationType>DynamicLibrary</ConfigurationType>"
      "<ConfigurationType>StaticLibrary</ConfigurationType>")
    if(VCPKG_CRT_LINKAGE STREQUAL "dynamic")
      file(GLOB_RECURSE PROJ_FILES
           "${SOURCE_PATH}/prj/${SOLUTION_TYPE}/*.vcxproj")
...
elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
  if(VCPKG_DETECTED_CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    ...
    vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}/prj/cmake" OPTIONS
  ...
  vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}/prj/cmake")
  vcpkg_cmake_install()
  vcpkg_cmake_config_fixup()
  vcpkg_copy_pdbs()
