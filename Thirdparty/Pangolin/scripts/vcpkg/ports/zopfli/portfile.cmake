vcpkg_from_github(
  ...
  google/zopfli
  REF
  bd64b2f0553d4f1ef4e6627647c5d9fc8c71ffc0 # zopfli-1.0.3
  SHA512
  3c99a4cdf3b2f0b619944bf2173ded8e10a89271fc4b2c713378b85d976a8580d15a473d5b0e6229f2911908fb1cc7397e516d618e61831c3becd65623214d94
  HEAD_REF
  master)
...
file(
  COPY "${CURRENT_PACKAGES_DIR}/bin/zopflipng${VCPKG_TARGET_EXECUTABLE_SUFFIX}"
  DESTINATION "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
...
if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Linux" OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL
  ...
  if(NOT VCPKG_BUILD_TYPE)
    vcpkg_replace_string(
      "${CURRENT_PACKAGES_DIR}/share/zopfli/ZopfliConfig-debug.cmake"
  ...
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/zopfli/ZopfliConfig-release.cmake"
