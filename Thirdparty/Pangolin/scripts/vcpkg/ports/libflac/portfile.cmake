vcpkg_from_github(
  ...
  xiph/flac
  REF
  1151c93e992bb8c7c6394e04aa880d711c531c7f # 1.3.4
  SHA512
  ebf8de3dbd8fc2153af2f4a05ecc04817570233c30e0ec1fbdbc99f810860801b951248ca6404152cba4038f5839985f4076bcee477c00fd23bd583a45b89b17
  HEAD_REF
  master
  PATCHES
...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS FEATURES asm WITH_ASM)
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/FLAC/export.h"
                       "#if defined(FLAC__NO_DLL)" "#if 0")
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/FLAC++/export.h"
                       "#if defined(FLAC__NO_DLL)" "#if 0")
else()
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/FLAC/export.h"
                       "#if defined(FLAC__NO_DLL)" "#if 1")
  vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/FLAC++/export.h"
                       "#if defined(FLAC__NO_DLL)" "#if 1")
endif()
...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/flac.pc")
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/flac.pc"
                         " -lm" "")
  endif()
endif()
...
# This license (BSD) is relevant only for library - if someone would want to
# install FLAC cmd line tools as well additional license (GPL) should be
# included
file(
  INSTALL "${SOURCE_PATH}/COPYING.Xiph"
