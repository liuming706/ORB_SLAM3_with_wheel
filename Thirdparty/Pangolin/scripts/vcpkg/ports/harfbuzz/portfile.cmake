...
if("icu" IN_LIST FEATURES)
  list(APPEND FEATURE_OPTIONS -Dicu=enabled) # Enable ICU library unicode
                                             # functions
else()
  list(APPEND FEATURE_OPTIONS -Dicu=disabled)
endif()
if("graphite2" IN_LIST FEATURES)
  list(APPEND FEATURE_OPTIONS -Dgraphite=enabled) # Enable Graphite2
                                                  # complementary shaper
else()
  list(APPEND FEATURE_OPTIONS -Dgraphite=disabled)
endif()
if("coretext" IN_LIST FEATURES)
  list(APPEND FEATURE_OPTIONS -Dcoretext=enabled) # Enable CoreText shaper
                                                  # backend on macOS
else()
...
list(APPEND FEATURE_OPTIONS -Dfreetype=enabled) # Enable freetype interop
                                                # helpers
# if(VCPKG_TARGET_IS_WINDOWS) link errors in qt5-base. probably requires changes
# to the pc files generated by meson list(APPEND FEATURE_OPTIONS -Dgdi=enabled)
# # enable gdi helpers and uniscribe shaper backend (windows only) endif()
...
vcpkg_configure_meson(
  ...
  -Dintrospection=disabled # Generate gobject-introspection bindings
                           # (.gir/.typelib files)
...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  foreach(PC_FILE IN LISTS PC_FILES)
    ...
    string(REGEX REPLACE "\\$\\{prefix\}\\/lib\\/([a-zA-Z0-9\-]*)\\.lib"
                         "-l\\1" PC_FILE_CONTENT "${PC_FILE_CONTENT}")
...
configure_file(
  "${CMAKE_CURRENT_LIST_DIR}/harfbuzzConfig.cmake.in"
