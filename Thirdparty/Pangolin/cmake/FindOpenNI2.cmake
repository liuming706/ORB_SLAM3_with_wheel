...
# Find OpenNI2
#
# This sets the following variables: OPENNI2_FOUND - True if OPENNI was found.
...
find_path(
  OPENNI2_INCLUDE_DIR OpenNI.h
  HINTS ${PC_OPENNI_INCLUDEDIR} ${PC_OPENNI_INCLUDE_DIRS}
  PATHS "${PROGRAM_FILES}/OpenNI2/Include"
        "${CMAKE_SOURCE_DIR}/../OpenNI2/Include" /usr/include /user/include
...
find_library(
  ...
  PATHS "${PROGRAM_FILES}/OpenNI2/Redist" "${PROGRAM_FILES}/OpenNI2"
        "${CMAKE_SOURCE_DIR}/../OpenNI2/Bin/x64-Release" /usr/lib /user/lib
...
find_package_handle_standard_args(OpenNI2 DEFAULT_MSG OPENNI2_LIBRARY
                                  OPENNI2_INCLUDE_DIR)
