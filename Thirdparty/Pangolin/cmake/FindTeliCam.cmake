...
#
# This sets the following variables: TeliCam_FOUND - True if TeliCam was found.
...
find_path(
  ...
  PATHS "${PROGRAM_FILES}/Toshiba Teli/TeliCamSDK/TeliCamApi/Include"
        "${CMAKE_SOURCE_DIR}/../TeliCamSDK/TeliCamApi/Include" /usr/include
        /user/include /opt/TeliCamSDK/include
...
find_library(
  ...
  PATHS "${PROGRAM_FILES}/Toshiba Teli/TeliCamSDK/TeliCamApi/lib"
        "${CMAKE_SOURCE_DIR}/../TeliCamSDK/TeliCamApi/lib" /usr/lib /user/lib
        /opt/TeliCamSDK/lib
