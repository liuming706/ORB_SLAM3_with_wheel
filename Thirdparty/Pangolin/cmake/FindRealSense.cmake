...
#
# This sets the following variables: REALSENSE_FOUND - True if RealSense was
# found. REALSENSE_INCLUDE_DIRS - Directories containing the RealSense include
# files. REALSENSE_LIBRARIES - Libraries needed to use RealSense.
...
find_path(REALSENSE_INCLUDE_DIR librealsense/rs.h HINTS /usr/include/
                                                        /usr/local/include)
# add a hint so that it can find it without the pkg-config
find_library(
  REALSENSE_LIBRARY
...
find_package_handle_standard_args(RealSense DEFAULT_MSG REALSENSE_LIBRARY
