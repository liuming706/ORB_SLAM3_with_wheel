...
#
# OPENNI_FOUND                True if OpenNI was found OPENNI_INCLUDE_DIRS The
# location(s) of OpenNI headers OPENNI_LIBRARIES            Libraries needed to
# use OpenNI OPENNI_DEFINITIONS          Compiler flags for OpenNI
...
find_library(
  ...
  HINTS ${PC_OPENNI_LIBDIR} ${PC_OPENNI_LIBRARY_DIRS} /usr/lib "${OPENNI_ROOT}"
        "$ENV{OPENNI_ROOT}"
